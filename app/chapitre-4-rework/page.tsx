...
export const metadata: Metadata = { title: 'Chapitre 4 — Nouvelle édition privée — Lecture classique — R.O.P.', description: 'Version privée reconstruite du chapitre 4 sur le système nerveux autonome.', robots: { index: false, follow: false } }
