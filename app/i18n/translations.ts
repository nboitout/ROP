...
const en: typeof fr = {
  ...
  hero: {
    ...
    cta2: 'View the contents',
    role: 'Reflexotherapist · Osteopath · Founder of R.O.P.',
    galleryKicker: "Author's Gallery",
    galleryTitle: 'Guy Boitout in training, teaching and practice.',
  },
  author: {
    lbl: 'The author',
