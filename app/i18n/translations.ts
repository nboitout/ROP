...
const fr = {
  ...
  chapters: {
    ...
    desc: "22 chapitres au total. Trois sont en accès libre — Introduction, Chapitre 4 et Chapitre 5 — pour découvrir la rigueur pédagogique de l'ouvrage. L'intégralité est disponible en Livre en ligne ou Livre en ligne + Livre imprimé.",
    parts: [
    ...
    cards: [
      ...
      { num: '04', part: 'sn' as const, variant: 'free' as const, label: 'Chapitre 4', title: 'Système nerveux autonome', tags: ['Parasympathique', 'Sympathique', 'Nerf vague', 'SNE', 'Homéostasie'], body: "Parasympathique et Sympathique : fonctions, homéostasie, relation SNA-sommeil, système nerveux entérique. Le nerf vague — 70 à 80 % de fibres sensitives afférentes — et son rôle anti-inflammatoire. Cadre clinique des déséquilibres neurovégétatifs en R.O.P." },
  ...
  freeChapter: {
    ...
    p1: "L'introduction, le chapitre sur le système nerveux autonome et le chapitre sur le mécanisme de stress sont mis en accès libre — pour découvrir la rigueur pédagogique et la profondeur clinique de cet ouvrage.",
    p2: "Lecture en ligne, avec illustrations. Une seule inscription donne accès aux trois chapitres complets, sans envoi de PDF.",
    note: 'Introduction · Chapitre 4 (à venir) · Chapitre 5',
  },
  citations: {
  ...
  form: {
    ...
    subtitle: 'Introduction · Chapitre 4 · Chapitre 5 — lecture en ligne immédiate',
    nameLbl: 'Prénom & Nom',
...
const en: typeof fr = {
  ...
  chapters: {
    ...
    desc: 'Twenty-two chapters in total. Three are freely available — Introduction, Chapter 4 and Chapter 5 — to discover the pedagogical rigor of the book. The complete work is available as Online Book or Online Book + Printed Book.',
    parts: [
...
const de: typeof fr = {
  ...
  chapters: {
    ...
    desc: 'Insgesamt 22 Kapitel. Drei sind frei zugänglich — Einführung, Kapitel 4 und Kapitel 5 —, um die pädagogische Genauigkeit des Werks kennenzulernen. Das vollständige Werk ist als Online-Buch oder Online-Buch + Druckausgabe erhältlich.',
    parts: [
    ...
    cards: [
      ...
      { num: '14', part: 'visceres' as const, label: 'Kapitel 14', title: 'Dünndarm', tags: ['Jejunum–Ileum', 'Mesenterium', 'Mikrobiom', 'Darm-Hirn-Achse', 'R.O.P.-Kartierung'], body: 'Anatomie von Jejunum–Ileum und Mesenterium aus einer klinischen R.O.P.-Perspektive: die Mesenterialwurzel als stark reflexogene Zone, Nutcracker-Syndrom, Darm-Hirn-Achse und die Beziehung zwischen Mikrobiom und Immunität. Reflexkartierung enthalten.' },
...
const es: typeof fr = {
  ...
  chapters: {
    ...
    desc: '22 capítulos en total. Tres son de acceso libre — Introducción, Capítulo 4 y Capítulo 5 — para descubrir el rigor pedagógico de la obra. El contenido completo está disponible como Libro online o Libro online + Edición impresa.',
    parts: [
    ...
    cards: [
      ...
      { num: '14', part: 'visceres' as const, label: 'Capítulo 14', title: 'Intestino delgado', tags: ['Yeyuno–íleon', 'Mesenterio', 'Microbioma', 'Eje intestino–cerebro', 'Cartografía R.O.P.'], body: 'Anatomía del yeyuno–íleon y del mesenterio desde una interpretación clínica R.O.P.: la raíz mesentérica como zona altamente reflexógena, síndrome de Nutcracker, eje intestino–cerebro y relación microbioma–inmunidad. Cartografía refleja incluida.' },
...
const it: typeof fr = {
  ...
  chapters: {
    ...
    desc: "22 capitoli in totale. Tre sono ad accesso libero — Introduzione, Capitolo 4 e Capitolo 5 — per scoprire il rigore pedagogico dell'opera. Il contenuto completo è disponibile come Libro online o Libro online + Edizione cartacea.",
    parts: [
    ...
    cards: [
      ...
      { num: '04', part: 'sn' as const, variant: 'free' as const, label: 'Capitolo 4', title: 'Sistema nervoso autonomo', tags: ['Parasimpatico', 'Simpatico', 'Nervo vago', 'Sistema nervoso enterico', 'Omeostasi'], body: 'Sistemi parasimpatico e simpatico: funzioni, omeostasi, relazione SNA–sonno e sistema nervoso enterico. Il nervo vago — con il 70–80% di fibre sensoriali afferenti — e il suo ruolo antinfiammatorio. Un quadro clinico per gli squilibri autonomici nella R.O.P.' },
