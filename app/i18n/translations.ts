  ...
  chaptersPage: {
    ...
    chapters: [
      ...
      },
      {
        ...
        eyebrow: 'Chapitre 8',
        title: 'Diaphragme',
        description: "Moteur respiratoire, viscéral et veino-lymphatique : centre phrénique, coupoles, piliers, orifices (hiatus aortique, oesophagien, veine cave), vascularisation, innervation — et zones réflexes podales en R.O.P.",
        meta: '~20 min de lecture',
      },
      {
        href: '/chapitre-9',
        eyebrow: 'Chapitre 9',
        title: 'Estomac',
        description: "Anatomie complète (SIO, fundus, corps, pylore), physiologie digestive acide, gastrite, gastroparésie, carences martiales, relations viscéro-émotionnelles et zones réflexes podales en R.O.P.",
        meta: '~20 min de lecture',
      },
      {
        href: '/chapitre-5',
  ...
  chaptersPage: {
    ...
    chapters: [
      ...
      },
      {
        ...
        eyebrow: 'Chapter 8',
        title: 'Diaphragm',
        description: 'Respiratory, visceral and venolymphatic motor: central tendon, domes, pillars, apertures (aortic, oesophageal, vena cava hiatus), vascularisation, innervation — and podal reflex zones in R.O.P.',
        meta: '~20 min read',
      },
      {
        href: '/chapitre-9',
        eyebrow: 'Chapter 9',
        title: 'Stomach',
        description: 'Complete anatomy (LOS, fundus, body, pylorus), acid digestive physiology, gastritis, gastroparesis, iron deficiency, viscero-emotional connections and podal reflex zones in R.O.P.',
        meta: '~20 min read',
      },
      {
        href: '/chapitre-5',
  ...
  chaptersPage: {
    ...
    chapters: [
      ...
      },
      {
        ...
        eyebrow: 'Kapitel 8',
        title: 'Zwerchfell',
        description: 'Respiratorischer, viszeraler und venolymphatischer Motor: Centrum tendineum, Kuppeln, Pfeiler, Oeffnungen (Aorten-, Oesophagus-, Vena-cava-Hiatus), Vaskularisierung, Innervation — podale Reflexzonen in der R.O.P.',
        meta: '~20 Min. Lektüre',
      },
      {
        href: '/chapitre-9',
        eyebrow: 'Kapitel 9',
        title: 'Magen',
        description: 'Vollständige Anatomie (UOS, Fundus, Corpus, Pylorus), saure Verdauungsphysiologie, Gastritis, Gastroparese, Eisenmangel, viszero-emotionale Zusammenhaenge und podale Reflexzonen in der R.O.P.',
        meta: '~20 Min. Lektüre',
      },
      {
        href: '/chapitre-5',
  ...
  chaptersPage: {
    ...
    chapters: [
      ...
      },
      {
        ...
        eyebrow: 'Capítulo 8',
        title: 'Diafragma',
        description: 'Motor respiratorio, visceral y venolinfático: centro frénico, cúpulas, pilares, orificios (hiato aórtico, esofágico, vena cava), vascularización, inervación — y zonas reflejas podales en R.O.P.',
        meta: '~20 min de lectura',
      },
      {
        href: '/chapitre-9',
        eyebrow: 'Capítulo 9',
        title: 'Estómago',
        description: 'Anatomía completa (EEI, fundus, cuerpo, píloro), fisiología digestiva ácida, gastritis, gastroparesia, déficit de hierro, relaciones viscero-emocionales y zonas reflejas podales en R.O.P.',
        meta: '~20 min de lectura',
      },
      {
        href: '/chapitre-5',
  ...
  chaptersPage: {
    ...
    chapters: [
      ...
      },
      {
        ...
        eyebrow: 'Capitolo 8',
        title: 'Diaframma',
        description: 'Motore respiratorio, viscerale e venolinfatico: centro frenico, cupole, pilastri, orifizi (iato aortico, esofageo, vena cava), vascolarizzazione, innervazione — e zone riflesse podali nella R.O.P.',
        meta: '~20 min di lettura',
      },
      {
        href: '/chapitre-9',
        eyebrow: 'Capitolo 9',
        title: 'Stomaco',
        description: "Anatomia completa (SIO, fundus, corpo, piloro), fisiologia digestiva acida, gastrite, gastroparesi, carenza di ferro, relazioni viscero-emozionali e zone riflesse podali nella R.O.P.",
        meta: '~20 min di lettura',
      },
      {
        href: '/chapitre-5',
