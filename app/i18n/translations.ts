...
const en: typeof fr = {
  ...
  chapters: {
    ...
    cards: [
      ...
      { num: '01', badgeLabel: 'Included', label: 'Chapter 1', title: 'Generalities — Visceral Mobility', tags: ['Visceral mobility', 'Turgor', 'Serous membranes', 'Biorhythms', 'Diaphragm', 'MRP'], body: "The mechanical and neurophysiological framework for the practitioner: mobility vs. motility, four visceral motors (somatic, autonomic, intrinsic motility, biorhythms), turgor, intra-cavity pressures and serous gliding." },
      { num: '02', badgeLabel: 'Included', label: 'Chapter 2', title: 'Treatment by R.O.P.', tags: ['Manual technique', 'Textural dosing', '3 session phases', 'Mechanoreceptors', 'Hierarchisation'], body: "The complete clinical protocol: gestural technique (thumb pad), textural dosing (drumskin effect), the 3 phases of a session, and hierarchical treatment — General syndrome → Loco-regional → Limbic. Neurophysiological foundations." },
      { num: '03', badgeLabel: 'Included', label: 'Chapter 3', title: 'Central nervous system', tags: ['Reptilian brain', 'Brainstem', 'Limbic system', 'Neurotransmitters', 'Reflex zones'], body: "From MacLean's three brains to the reticular formation: brainstem, cerebellum, limbic system and cortex, basal ganglia and neurotransmitters. Podal and occipital reflex zones for each cerebral structure." },
