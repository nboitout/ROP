...
const fr = {
  ...
  chapters: {
    ...
    desc: "22 chapitres au total. Trois sont en accès libre — Introduction, Chapitre 3 et Chapitre 5 — pour découvrir la rigueur pédagogique de l'ouvrage. L'intégralité est disponible en Livre en ligne ou Livre en ligne + Livre imprimé.",
    parts: [
  ...
  form: {
    ...
    subtitle: 'Introduction · Chapitre 3 · Chapitre 5 — lecture en ligne immédiate',
    nameLbl: 'Prénom & Nom',
...
const en: typeof fr = {
  ...
  chapters: {
    ...
    desc: 'Twenty-two chapters in total. Three are freely available — Introduction, Chapter 3 and Chapter 5 — to discover the pedagogical rigor of the book. The complete work is available as Online Book or Online Book + Printed Book.',
    parts: [
...
const de: typeof fr = {
  ...
  chapters: {
    ...
    desc: 'Insgesamt 22 Kapitel. Drei sind frei zugänglich — Einführung, Kapitel 3 und Kapitel 5 —, um die pädagogische Genauigkeit des Werks kennenzulernen. Das vollständige Werk ist als Online-Buch oder Online-Buch + Druckausgabe erhältlich.',
    parts: [
...
const es: typeof fr = {
  ...
  chapters: {
    ...
    desc: '22 capítulos en total. Tres son de acceso libre — Introducción, Capítulo 3 y Capítulo 5 — para descubrir el rigor pedagógico de la obra. El contenido completo está disponible como Libro online o Libro online + Edición impresa.',
    parts: [
...
const it: typeof fr = {
  ...
  chapters: {
    ...
    desc: "22 capitoli in totale. Tre sono ad accesso libero — Introduzione, Capitolo 3 e Capitolo 5 — per scoprire il rigore pedagogico dell'opera. Il contenuto completo è disponibile come Libro online o Libro online + Edizione cartacea.",
    parts: [
