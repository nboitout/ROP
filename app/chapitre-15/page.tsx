...
export const metadata: Metadata = {
  ...
  description: 'Anatomie, physiologie, pathologies courantes et zones réflexes podales du côlon et du rectum en R.O.P.',
  robots: { index: false, follow: false },
}

// Classic single-column reading. The synchronized reader at /lecture/chapitre-15 is
// the default entry; this route is reachable from its large-screen mode switch.
export default async function Chapitre15ClassicPage({
  searchParams,
}: {
  ...
  const syncHref = `/lecture/chapitre-15?lang=${lang}`
