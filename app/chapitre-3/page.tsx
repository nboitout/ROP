...
// Classic single-column reading. The synchronized reader at /lecture/chapitre-3 is
// the default entry; this route is reachable from its large-screen mode switch.
export default async function Chapitre3ClassicPage({
  searchParams,
}: {
  ...
  const syncHref = `/lecture/chapitre-3?lang=${lang}`
