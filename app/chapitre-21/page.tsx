...
// Classic single-column reading. The synchronized reader at /lecture/chapitre-21 is
// the default entry; this route is reachable from its large-screen mode switch.
export default async function Chapitre21ClassicPage({
  searchParams,
}: {
  ...
  const syncHref = `/lecture/chapitre-21?lang=${lang}`
