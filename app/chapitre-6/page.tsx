...
// Classic single-column reading. The synchronized reader at /lecture/chapitre-6 is
// the default entry; this route is reachable from its large-screen mode switch.
export default async function Chapitre6ClassicPage({
  searchParams,
}: {
  ...
  const { chapter, contentLang } = getChapter('chapter-6', 'fr')
  const syncHref = `/lecture/chapitre-6?lang=${lang}`
