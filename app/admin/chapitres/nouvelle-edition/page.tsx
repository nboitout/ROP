  ...
  return (
    <main className="adm-page">
      ...
      <section className="adm-edition-grid" aria-label="Private-edition chapter status">
        <article className="adm-edition-card test"><p className="adm-edition-status">Rebuilt</p><h2>Chapter 5 · Stress mechanism</h2><p>Private revised edition with synchronized slides, annexes, bibliography, and dedicated reflex-zone sequence.</p><div className="adm-edition-actions"><Link href="/lecture/chapitre-5-rework" target="_blank">Synchronized reading →</Link><Link href="/chapitre-5-rework" target="_blank">Classic reading →</Link></div></article>
