    ...
    <main className="adm-page">
      <div className="adm-page-header">
        <div>
          ...
          <h1 className="adm-page-title">Nouvelle édition privée</h1>
          <p className="adm-page-sub">A focused private rebuild of Chapter 3. The published chapter remains unchanged.</p>
        </div>
      </div>
      ...
      <nav className="adm-edition-tabs" aria-label="Book edition">
        ...
        <Link href="/admin/chapitres/nouvelle-edition" className="adm-edition-tab active">Private edition</Link>
      </nav>
      ...
      <section className="adm-edition-grid" aria-label="Private-edition chapter status">
        <article className="adm-edition-card test">
          ...
          <h2>Chapter 3 · Central nervous system</h2>
          ...
          <div className="adm-edition-actions">
            <Link href="/lecture/chapitre-3-rework" target="_blank">Synchronized reading →</Link>
