...
const ROUTES: Record<string, { href: string; key: string; gated?: boolean; draft?: boolean }> = {
  ...
  '01': { href: '/lecture/chapitre-1', key: 'chapter-1' },
  ...
  '07': { href: '/lecture/chapitre-7', key: 'chapter-7' },
  '08': { href: '/lecture/chapitre-8', key: 'chapter-8' },
  '09': { href: '/lecture/chapitre-9', key: 'chapter-9' },
  '10': { href: '/lecture/chapitre-10', key: 'chapter-10' },
  ...
  return (
    <main className="adm-page">
      ...
      <nav className="adm-edition-tabs" aria-label="Book edition">
        ...
        <Link href="/admin/chapitres/nouvelle-edition" className="adm-edition-tab">Nouvelle édition</Link>
      </nav>
