    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "rop", body: [
          ...
          "En este enfoque, estas reacciones se interpretan a la luz de la ley de Hering, según la cual los síntomas evolucionan hacia la curación cuando progresan:",
          "• De arriba abajo.",
          "• De dentro hacia fuera.",
          "• De lo crónico hacia lo agudo.",
          "• Pasando de nuevo por fases anteriores de la enfermedad.",
          ...
          "La técnica de masaje en ROP puede descomponerse en tres tiempos:",
          "• Diagnóstico tisular.",
          "• Estimulación de la zona.",
          "• Tiempo de “no hacer nada y dejar actuar”.",
          "Se ajusta así a la regla formulada por el fundador de la osteopatía, el Dr. A. T. Still: “Find it, fix it and leave it alone”.",
        ]},
