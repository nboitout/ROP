...
// Source: public/chapter-3/Chapitre_3_SNC_AI_Rework.docx

import type { Chapter } from './types'

export const chapter3ReworkFr: Chapter = {
  slug: 'chapter-3-rework',
  number: '3',
  title: 'Système nerveux central (SNC)',
  sections: [
  {
    "id": "presentation-pourquoi-commencer-par-le-systeme-nerveux-central",
    "title": "1. Présentation : pourquoi commencer par le système nerveux central ?",
    "blocks": [
      {
        "type": "para",
        "text": "Niveau 1 du protocole ROP — Régulation des centres supérieurs"
      },
      {
        "type": "para",
      ...
      {
        "type": "para",
        "text": "Les réseaux limbiques et corticaux sont également décrits dans ce chapitre parce qu’ils appartiennent au SNC et participent à l’intégration supraspinale. Leur utilisation clinique dans les relations viscéro-émotionnelles sera cependant reprise au Niveau 4."
      }
    ]
  },
  {
    "id": "du-corps-vers-les-centres-dintegration-une-lecture-simple",
  ...
  {
    "id": "le-tronc-cerebral-premier-grand-carrefour-supraspinal",
    ...
    "blocks": [
      ...
      {
        "type": "para",
        "text": "Pour notre modèle, elle constitue un exemple de relais supraspinal capable de transformer une information ascendante en une réponse descendante modulant les circuits spinaux."
      }
    ]
  },
  {
    "id": "diencephale-relier-sensation-homeostasie-et-adaptation",
  ...
  {
    "id": "reseaux-corticaux-et-cortico-limbiques-percevoir-letat-du-corps-et-lui-donner-un-contexte",
  ...
  {
    "id": "environnement-neuro-meninge-et-circulation-liquidienne",
    ...
    "blocks": [
      ...
      {
        "type": "para",
        "text": "Le système glymphatique désigne des échanges périvasculaires participant à la circulation des liquides et à l’élimination de certains déchets métaboliques dans le cerveau. Il fonctionne en relation avec le LCR et avec les vaisseaux lymphatiques des méninges, sans se confondre avec eux."
      },
      {
        "type": "sub",
  ...
  {
    "id": "deux-reperes-complementaires-cervelet-et-ganglions-de-la-base",
  ...
  {
    "id": "le-niveau-1-en-rop-quelle-logique-clinique",
    ...
    "blocks": [
      ...
      {
        "type": "para",
        "text": "Le lien avec la ROP viscérale apparaît surtout dans la capacité du SNC à intégrer des informations somatiques et viscérales et à modifier ensuite les commandes descendantes. Cette logique complète les mécanismes spinaux et autonomes étudiés dans les chapitres suivants."
      },
      {
        "type": "lead",
        "label": "Schéma de lecture",
        "text": "entrée somatique → moelle → tronc cérébral → réseaux corticaux et cortico-limbiques → commandes descendantes."
      }
    ]
  },
  {
    "id": "zones-reflexes-rop-du-niveau-1",
    ...
    "blocks": [
      ...
      },
      {
        "type": "bullets",
        "items": [
          "Dure-mère, faux du cerveau, faux du cervelet et tente du cervelet : se reporter aux repères détaillés du volume consacré au système neuro-méningé.",
    ...
    "blocks": [
      {
        ...
        "items": [
          ...
          "Le principe central est celui d’une modulation de réseaux : une entrée somatique peut rejoindre la moelle, le tronc cérébral et les centres supérieurs, puis influencer des commandes descendantes."
        ]
      }
    ]
  },
  {
    "id": "annexe-reperes-fonctionnels-des-principales-structures-etudiees",
  ...
  {
    "id": "references-complementaires-pour-les-ajouts-neurophysiologiques",
