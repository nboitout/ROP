...
const reworkFigure = (slide: string, caption: string, orientation: 'landscape' | 'portrait' = 'landscape'): Block => ({ type: 'figure', src: `/chapter-3/FR/cartographies/slide-${slide}.png`, caption, alt: caption, orientation })
