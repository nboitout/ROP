...
export const chapter5ReworkSlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'le-cout-de-regulation-une-mobilisation-active-pas-une-batterie-qui-se-vide', blockIndex: 3, slide: 13, end: { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: -1 } },
  { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: -1, slide: 14, end: { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: 5 } },
  { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: 5, slide: 15, end: { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: 10 } },
  { sectionId: 'a-l-echelle-cellulaire-le-cout-de-la-compensation', blockIndex: 10, slide: 16, end: { sectionId: 'le-modele-du-seuil-trouble-fonctionnel-et-alteration-structurelle', blockIndex: -1 } },
  { sectionId: 'le-modele-du-seuil-trouble-fonctionnel-et-alteration-structurelle', blockIndex: -1, slide: 17, end: { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: -1 } },
  { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: -1, slide: 18, end: { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: 1 } },
  ...
  { sectionId: 'le-pont-avec-la-rop-agir-sur-la-reponse-non-sur-l-existence-du-stresseur', blockIndex: 0, slide: 20, end: { sectionId: 'la-seance-rop-stimuler-puis-laisser-integrer', blockIndex: -1 } },
  { sectionId: 'la-seance-rop-stimuler-puis-laisser-integrer', blockIndex: -1, slide: 21, end: { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: -1 } },
  { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: -1, slide: 22, end: { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 1 } },
  { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 1, slide: 23, end: { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 4 } },
  { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 4, slide: 24, end: { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 7 } },
  { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 7, slide: 25, end: { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 10 } },
  { sectionId: 'proposition-de-sequence-clinique-rop-en-quatre-niveaux', blockIndex: 10, slide: 26, end: { sectionId: 'vers-une-recherche-sur-la-cinetique-de-recuperation', blockIndex: -1 } },
