    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "rop", body: [
          ...
          "In this model, these reactions are interpreted in the light of Hering’s law, which states that symptoms evolve towards healing when they move: from top to bottom; from the inside out; from chronic towards acute; and by passing again through earlier phases of the disease.",
          ...
          "The ROP massage technique can be broken down into three stages: 1. tissue diagnosis; 2. stimulation of the zone; 3. a period of “doing nothing and allowing things to happen”. It is consistent with the rule already formulated by the founder of osteopathy, Dr A. T. Still: “Find it, fix it and leave it alone.”",
        ]},
