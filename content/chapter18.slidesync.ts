...
export const chapter18SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 12, slide: 23, end: { sectionId: 'zones-reflexes-podales', blockIndex: 12 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 13, slide: 24, end: { sectionId: 'zones-reflexes-podales', blockIndex: 13 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 25, end: { sectionId: 'zones-reflexes-podales', blockIndex: 14 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 20, slide: 26, end: { sectionId: 'zones-reflexes-podales', blockIndex: 20 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 21, slide: 27, end: { sectionId: 'zones-reflexes-podales', blockIndex: 21 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 22, slide: 28, end: { sectionId: 'zones-reflexes-podales', blockIndex: 22 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 23, slide: 29, end: { sectionId: 'zones-reflexes-podales', blockIndex: 23 } },
]
