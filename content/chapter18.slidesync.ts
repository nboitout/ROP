...
export const chapter18SlidesEn = withChapter18Titles([
  ...
  'Viscerosomatic relations — bladder',
...
export const chapter18SlidesDe = withChapter18Titles([
  ...
  'Viszerosomatische Beziehungen — Blase',
...
export const chapter18SlidesEs = withChapter18Titles([
  ...
  'Relaciones viscerosomáticas — vejiga',
...
export const chapter18SlidesIt = withChapter18Titles([
  ...
  'Relazioni viscerosomatiche — vescica',
...
export const chapter18SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'conseils', blockIndex: 0, slide: 21, end: { sectionId: 'conseils', blockIndex: 1, itemIndex: 5 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: -1, slide: 22 },
  {
    sectionId: 'zones-reflexes-podales',
    blockIndex: 1,
    slide: 23,
    end: { sectionId: 'zones-reflexes-podales', blockIndex: 7, itemIndex: 4 },
  },
  { sectionId: 'zones-reflexes-podales', blockIndex: 12, slide: 24, end: { sectionId: 'zones-reflexes-podales', blockIndex: 12 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 13, slide: 25, end: { sectionId: 'zones-reflexes-podales', blockIndex: 13 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 26, end: { sectionId: 'zones-reflexes-podales', blockIndex: 14 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 20, slide: 27, end: { sectionId: 'zones-reflexes-podales', blockIndex: 20 } },
