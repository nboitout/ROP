...
export const chapter18SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'presentation', blockIndex: 0, slide: 2, end: { sectionId: 'presentation', blockIndex: 2 } },
...
export const chapter18SlidesEn: SyncSlide[] = [
  ...
  { src: '/chapter-18/EN/Images/NCH 18 EN IMG 15 V2.png', title: 'Pathological Mechanisms and Dysfunctions' },
  ...
  { src: '/chapter-18/EN/Images/NCH 18 EN VISCEROSOMATIC RELATIONSHIPS V2.png', title: 'Viscerosomatic Relationships — Bladder' },
  ...
  { src: '/chapter-18/EN/Cartography/figure-18-09.png', title: 'Mapping: Bladder, Uterus or Prostate — Pubovesical Ligament' },
  { src: '/chapter-18/EN/Cartography/figure-18-11.png', title: 'Mapping: Bladder, Uterus or Prostate — Trigone' },
  { src: '/chapter-18/EN/Cartography/figure-18-13.png', title: 'Mapping: Bladder, Uterus or Prostate — Perineum' },
  { src: '/chapter-18/EN/Cartography/figure-18-01.png', title: 'Mapping: Greater and Lesser Sciatic Foramina' },
  { src: '/chapter-18/EN/Cartography/figure-18-03.png', title: 'Mapping: Greater and Lesser Sciatic Foramina' },
  { src: '/chapter-18/EN/Cartography/figure-18-05.png', title: 'Mapping: Obturator Foramen, Obturator Muscles and Pudendal Nerve' },
  { src: '/chapter-18/EN/Cartography/figure-18-07.png', title: 'Mapping: Sacrotuberous and Sacrospinous Ligaments, Pudendal Nerve' },
].map((slide) => ({ ...slide, src: `${slide.src}?v=20260826-en` }))

// Both language variants share the same final block and item coordinates.
export const chapter18SlideAnchorsEn: SyncAnchor[] = chapter18SlideAnchors.map(anchor =>
