...
export const chapter17Slides: SyncSlide[] = [
  ...
  { src: '/chapter-17/slides/slide-07.png', title: 'Biomécanique : gestion des pressions et de la gravité' },
  { src: '/chapter-17/slides/slide-08.png', title: 'L’équilibre ligamentaire : les freins sacrés' },
  { src: '/chapter-17/slides/slide-09.png', title: 'Le périnée : limites et organisation' },
  { src: '/chapter-17/slides/slide-10.png', title: 'Parois et musculature profonde du pelvis' },
  { src: '/chapter-17/slides/slide-11.png', title: 'Vascularisation artérielle et drainage veineux du pelvis' },
  { src: '/chapter-17/slides/slide-12.png', title: 'Innervation somatique I : le piège du piriforme' },
  { src: '/chapter-17/slides/slide-13.png', title: 'Innervation somatique II : le trajet du nerf pudendal' },
  { src: '/chapter-17/slides/slide-14.png', title: 'Innervation autonome et contrôle central' },
  { src: '/chapter-17/slides/slide-15.png', title: 'Les centres supérieurs neuro-végétatifs' },
  { src: '/chapter-17/slides/slide-16.png', title: 'Biomécanique : gestion des pressions et de la gravité' },
  { src: '/chapter-17/slides/slide-17.png', title: 'Biomécanique : équilibre des trois diaphragmes' },
  { src: '/chapter-17/slides/slide-18.png', title: 'Pathologie biomécanique : la ptose viscérale' },
  { src: '/chapter-17/slides/slide-19.png', title: 'Syndrome pudendal' },
  { src: '/chapter-17/slides/slide-20.png', title: 'Synthèse clinique : défaillances mécaniques et neurologiques' },
  { src: '/chapter-17/slides/slide-21.png', title: 'Synthèse clinique ROP : zones réflexes et cibles' },
]
...
export const chapter17SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'anatomie', blockIndex: 4, slide: 6 },
  { sectionId: 'anatomie', blockIndex: 7, slide: 7 },
  { sectionId: 'anatomie', blockIndex: 10, slide: 8 },
  { sectionId: 'anatomie', blockIndex: 13, slide: 9 },
  { sectionId: 'anatomie', blockIndex: 14, slide: 10 },
  { sectionId: 'vascularisation', blockIndex: 0, slide: 11 },
  { sectionId: 'innervation', blockIndex: 0, slide: 12 },
  { sectionId: 'innervation', blockIndex: 1, slide: 13 },
  { sectionId: 'innervation', blockIndex: 6, slide: 14 },
  { sectionId: 'innervation', blockIndex: 8, slide: 15 },
  { sectionId: 'innervation', blockIndex: 13, slide: 16 },
  { sectionId: 'innervation', blockIndex: 15, slide: 17 },
  { sectionId: 'pathologies-courantes', blockIndex: 0, slide: 18 },
  { sectionId: 'pathologies-courantes', blockIndex: 4, slide: 19 },
  { sectionId: 'pathologies-courantes', blockIndex: 16, slide: 20 },
