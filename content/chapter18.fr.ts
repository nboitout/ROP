...
chapter18Section('zones-reflexes-podales').title = '13. Zones réflexes ROP'
...
chapter18Section('zones-reflexes-podales').blocks = [
  { type: 'para', text: 'Pour la vessie, cette cartographie ROP est particulièrement intéressante car elle peut être organisée selon les quatre niveaux du protocole ROP, depuis les centres d’intégration jusqu’aux relations somatiques et émotionnelles.' },
  { type: 'sub', text: '13.1. Niveau 1 — Régulation des centres supérieurs' },
  ...
  { type: 'bullets', items: ['Parasympathique pelvien (sacré) : moelle sacrée S2-S4 (étage vertébral L1-L2), selon la cartographie médullaire ROP.', 'Colonne vertébrale et articulations costo-transversaires de Th10 à L2 (repères vertébraux Th11-T12).', 'Chaîne ganglionnaire latéro-vertébrale thoracique inférieure, lombaire et sacrée.', 'Plexus hypogastrique inférieur : repères pelviens de la cartographie ROP.', 'Nerfs hypogastriques : à considérer comme voie de distribution sympathique régionale.', 'Coordination stockage-vidange : à privilégier comme logique fonctionnelle plutôt qu’une stimulation isolée du sympathique ou du parasympathique.'] },
