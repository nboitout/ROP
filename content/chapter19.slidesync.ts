...
export const chapter19Slides: SyncSlide[] = [
  ...
  { src: '/chapter-19/slides/slide-16.png', title: 'De la plainte à l’orientation' },
  { src: '/chapter-19/slides/slide-17.png', title: 'Douleurs pelviennes — douleurs cycliques' },
  { src: '/chapter-19/slides/slide-18.png', title: 'Douleurs pelviennes — douleurs non cycliques' },
  { src: '/chapter-19/slides/slide-19.png', title: 'Dyspareunies — superficielles, intermédiaires et profondes' },
  { src: '/chapter-19/slides/slide-20.png', title: 'Hémorragies génitales — ménorragies et métrorragies' },
  { src: '/chapter-19/slides/slide-21.png', title: 'Aménorrhées — primaires ou secondaires' },
  { src: '/chapter-19/slides/slide-22.png', title: 'Leucorrhées pathologiques — pertes vaginales anormales' },
  ...
  { src: '/chapter-19/slides/slide-25.png', title: 'Fibrome utérin' },
  { src: '/chapter-19/slides/slide-26.png', title: 'Kystes ovariens — fonctionnels ou organiques' },
  { src: '/chapter-19/slides/slide-27.png', title: 'Pathologies fonctionnelles et chaînes lésionnelles' },
  { src: '/chapter-19/slides/slide-28.png', title: 'Conséquences possibles d’une perte de mobilité pelvienne' },
  { src: '/chapter-19/slides/slide-29.png', title: 'Syndrome prémenstruel — manifestations de la phase lutéale' },
  { src: '/chapter-19/slides/slide-30.png', title: 'Règles douloureuses — rôle des prostaglandines' },
  { src: '/chapter-19/slides/slide-31.png', title: 'Endométriose : maladie inflammatoire chronique' },
  { src: '/chapter-19/slides/slide-32.png', title: 'Vécu émotionnel, stress et symptômes uro-génitaux ou mammaires' },
  { src: '/chapter-19/slides/slide-33.png', title: 'Synthèse du protocole ROP — utérus, ovaires et trompes' },
]
...
export const chapter19SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'approche-clinique-commune', blockIndex: 1, slide: 16 },
  { sectionId: 'approche-clinique-commune', blockIndex: 4, itemIndex: 0, slide: 17 },
  { sectionId: 'approche-clinique-commune', blockIndex: 4, itemIndex: 1, slide: 18 },
  { sectionId: 'approche-clinique-commune', blockIndex: 4, itemIndex: 2, slide: 19 },
  { sectionId: 'approche-clinique-commune', blockIndex: 6, slide: 20 },
  { sectionId: 'approche-clinique-commune', blockIndex: 8, slide: 21 },
  { sectionId: 'approche-clinique-commune', blockIndex: 10, slide: 22 },
  { sectionId: 'approche-clinique-commune', blockIndex: 13, itemIndex: 0, slide: 23 },
  { sectionId: 'approche-clinique-commune', blockIndex: 13, itemIndex: 2, slide: 24 },
  { sectionId: 'approche-clinique-commune', blockIndex: 13, itemIndex: 4, slide: [25, 26] },
  { sectionId: 'approche-clinique-commune', blockIndex: 16, slide: 27 },
  { sectionId: 'approche-clinique-commune', blockIndex: 18, slide: 28 },
  { sectionId: 'approche-clinique-commune', blockIndex: 20, slide: 29 },
  { sectionId: 'approche-clinique-commune', blockIndex: 22, slide: 30 },
  { sectionId: 'approche-clinique-commune', blockIndex: 24, slide: 31 },
  { sectionId: 'approche-clinique-commune', blockIndex: 29, slide: 32 },
  { sectionId: 'zones-reflexes-podales', blockIndex: -1, slide: 33 },
]
