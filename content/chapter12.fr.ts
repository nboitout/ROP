// Source: public/chapter-12/FR/Chapitre_12_Pancreas_version_finale_publiable.docx
  ...
  "sections": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "para",
          "text": "Sa fixation est importante."
        },
        {
          "type": "para",
        ...
        {
          "type": "para",
          "text": "Sa face ventrale est adjacente au pylore."
        },
        {
          "type": "sub",
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "para",
          "text": "Cette organisation temoigne de liens physiologiques etroits entre ces organes."
        },
        {
          "type": "sub",
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "para",
          "text": "Atteinte vasculaire avec risque de baisse visuelle severe, voire de cecite."
        },
        {
          "type": "sub",
        ...
        {
          "type": "para",
          "text": "Le pronostic reste sombre."
        },
        {
          "type": "para",
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "para",
          "text": "La ROP peut viser ici un accompagnement fonctionnel de la digestion."
        },
        {
          "type": "bullets",
          "items": [
...
chapter12ReflexSection.blocks = [
  ...
  { type: 'figure', src: '/chapter-12/FR/cartographies/figure-12-02.png', caption: 'Photo : Pancréas — tête et col', alt: 'Repère podal de la tête et du col du pancréas', orientation: 'portrait' },
  { type: 'para', text: 'Corps et queue du pancréas. Ils se prolongent transversalement vers la rate, en arrière de l’estomac.' },
  { type: 'figure', src: '/chapter-12/FR/cartographies/figure-12-04.png', caption: 'Photo : Pancréas — corps et queue', alt: 'Repère podal du corps et de la queue du pancréas', orientation: 'portrait' },
  ...
  { type: 'xref', label: 'Voir le chapitre 5 — Mécanisme de stress', href: '/lecture/chapitre-5-rework?lang=fr' },
  { type: 'rop', body: ['Le Niveau 1 ne vise pas directement le pancréas. Il prépare le terrain adaptatif lorsque les tests et l’état général du patient le justifient.'] },
  ...
  { type: 'bullets', items: ['Tête et col, corps et queue du pancréas.', 'Duodénum et sphincter d’Oddi.', 'Foie, voies biliaires et estomac selon les tests.', 'Rate et pédicule splénique.', 'Racine du mésocôlon transverse, côlon transverse et rein gauche selon le contexte.'] },
  ...
  { type: 'bullets', items: ['Duodénum et voies biliaires.', 'Foie et estomac.', 'Rate et pédicule splénique.', 'Diaphragme.', 'Côlon transverse et rein gauche selon le contexte.'] },
