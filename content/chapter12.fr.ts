...
if (chapter12ReflexSection) chapter12ReflexSection.blocks = [
  ...
  { type: 'rop', body: ['La distinction tête-col, corps et queue permet d’adapter la lecture à l’organisation anatomique du pancréas sans attribuer à chaque zone une fonction isolée.'] },
  ...
  { type: 'xref', label: 'Voir le chapitre 3 — Système nerveux central', href: '/lecture/chapitre-3-rework?lang=fr' },
  { type: 'xref', label: 'Voir le chapitre 5 — Mécanisme de stress', href: '/lecture/chapitre-5-rework?lang=fr' },
  { type: 'rop', body: ['Le Niveau 4 associe les convergences somatiques et la dimension émotionnelle propre à la méthode, avec une vigilance particulière pour l’état des pieds chez les patients diabétiques.'] },
