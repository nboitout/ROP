...
chapter12ReflexSection.blocks = [
  ...
  { type: 'figure', src: '/chapter-12/FR/cartographie/figure-12-02.png', caption: 'Photo : Pancréas — tête et col', alt: 'Repère podal de la tête et du col du pancréas', orientation: 'portrait' },
  { type: 'para', text: 'Corps et queue du pancréas. Ils se prolongent transversalement vers la rate, en arrière de l’estomac.' },
  { type: 'figure', src: '/chapter-12/FR/cartographie/figure-12-04.png', caption: 'Photo : Pancréas — corps et queue', alt: 'Repère podal du corps et de la queue du pancréas', orientation: 'portrait' },
