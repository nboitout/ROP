// Introduction — French
// Source: assets/Introduction -- version sur le site .docx (Guy Boitout)
  ...
  sections: [
    {
      ...
      title: 'Avant-propos',
      blocks: [
        { type: 'para', text: 'Ce troisième volume de Réflexothérapie occipito-podale prolonge naturellement les deux précédents : après le système ostéo-musculo-articulaire (tome 1) puis le système neuro-méningé (tome 2), nous entrons ici dans le champ du viscéral abdomino-pelvien, du système nerveux autonome et du mécanisme du stress.' },
        { type: 'para', text: 'L’ambition reste la même : une cartographie cohérente avec l’anatomie et la physiologie, pensée en 3D, sous la forme d’un bébé en position fœtale dans le pied, et articulée avec les zones réflexes occipitales.' },
      ],
    },
    {
      id: 'en-bref',
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          'Des repères cliniques et une logique de palpation pour localiser les zones réflexes, malgré les faibles repères osseux de la face plantaire.',
