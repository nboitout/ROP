...
export const chapter4ReworkSlides = [
  ...
  synthesis(26, 'Nerfs splanchniques'),
...
export const chapter4ReworkSlideAnchors = [
  ...
  {
    sectionId: 'sympathique-somato-viscero-sensitif',
    blockIndex: 7,
    slide: 26,
  ...
  { sectionId: 'glandes-surrenales', blockIndex: -1, slide: 31 },
  { sectionId: 'glandes-surrenales', blockIndex: 6, slide: 32, ...endAt('glandes-surrenales', 8) },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 3, slide: 35, ...endAt('zones-reflexes-podales', 6) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, slide: 36, ...endAt('zones-reflexes-podales', 7) },
  {
    sectionId: 'zones-reflexes-podales',
    blockIndex: 9,
    itemIndex: 3,
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 11, slide: 38, ...endAt('zones-reflexes-podales', 14) },
  // The updated slide-11 photo now accompanies the right-vagus cartography.
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 39, ...endAt('zones-reflexes-podales', 15) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, slide: 40, ...endAt('zones-reflexes-podales', 20) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 20, slide: 41, ...endAt('zones-reflexes-podales', 24) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 42, ...endAt('zones-reflexes-podales', 27) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 27, slide: 43, ...endAt('zones-reflexes-podales', 30) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 44, ...endAt('zones-reflexes-podales', 33) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 45, ...endAt('zones-reflexes-podales', 37) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 37, slide: 46, ...endAt('zones-reflexes-podales', 41) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 41, slide: 47, ...endAt('zones-reflexes-podales', 45) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 51, slide: 48, ...endAt('zones-reflexes-podales', 54) },
  // Ends after the paired photo and before 11.16. Système nerveux intrinsèque ou entérique (SNE).
  { sectionId: 'zones-reflexes-podales', blockIndex: 54, slide: 49, ...endAt('zones-reflexes-podales', 55) },
]
