...
export const chapter4ReworkSlides = [
  ...
  synthesis(28, 'Intéroception, nociception et douleurs rapportées — application en ROP'),
...
export const chapter4ReworkSlideAnchors = [
  ...
  { sectionId: 'sympathique-somato-viscero-sensitif', blockIndex: 3, slide: 26 },
  { sectionId: 'sympathique-somato-viscero-sensitif', blockIndex: 5, slide: 27 },
  { sectionId: 'chaine-plexique-prevertebrale-ou-pre-aortique', blockIndex: 3, slide: 28 },
  { sectionId: 'plexus-previsceral-pelvien', blockIndex: -1, slide: 29 },
  { sectionId: 'plexus-previsceral-pelvien', blockIndex: 2, slide: 30 },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 3, slide: 36, ...endAt('zones-reflexes-podales', 6) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, slide: 37, ...endAt('zones-reflexes-podales', 7) },
  {
    sectionId: 'zones-reflexes-podales',
    blockIndex: 9,
    itemIndex: 3,
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 43, ...endAt('zones-reflexes-podales', 27) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 27, slide: 44, ...endAt('zones-reflexes-podales', 30) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 45, ...endAt('zones-reflexes-podales', 33) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 46, ...endAt('zones-reflexes-podales', 37) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 37, slide: 47, ...endAt('zones-reflexes-podales', 41) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 41, slide: 48, ...endAt('zones-reflexes-podales', 45) },
