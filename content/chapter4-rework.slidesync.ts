...
const priorSlideAnchors = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 11, slide: 33, ...endAt('zones-reflexes-podales', 15) },
  // The right-vagus cartography is intentionally solo after removal of its former companion.
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 34, ...endAt('zones-reflexes-podales', 15) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, slide: 35, ...endAt('zones-reflexes-podales', 20) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 20, slide: 36, ...endAt('zones-reflexes-podales', 24) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 37, ...endAt('zones-reflexes-podales', 27) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 27, slide: 38, ...endAt('zones-reflexes-podales', 30) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 39, ...endAt('zones-reflexes-podales', 33) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 40, ...endAt('zones-reflexes-podales', 37) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 37, slide: 41, ...endAt('zones-reflexes-podales', 41) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 41, slide: 42, ...endAt('zones-reflexes-podales', 45) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 51, slide: 43, ...endAt('zones-reflexes-podales', 54) },
  // Ends after the paired photo and before 11.16. Système nerveux intrinsèque ou entérique (SNE).
  { sectionId: 'zones-reflexes-podales', blockIndex: 54, slide: 44, ...endAt('zones-reflexes-podales', 55) },
]
