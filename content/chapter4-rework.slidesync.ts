...
const priorSlideAnchors = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 0, slide: 29, ...endAt('zones-reflexes-podales', 1) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 2, slide: 30, ...endAt('zones-reflexes-podales', 5) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, slide: 31, ...endAt('zones-reflexes-podales', 6) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 7, slide: 32, ...endAt('zones-reflexes-podales', 10) },
