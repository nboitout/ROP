...
const priorSlideAnchors = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 1, slide: 29, ...endAt('zones-reflexes-podales', 1) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 5, slide: 30, ...endAt('zones-reflexes-podales', 5) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, slide: 31, ...endAt('zones-reflexes-podales', 6) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 10, slide: 32, ...endAt('zones-reflexes-podales', 10) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 33, ...endAt('zones-reflexes-podales', 14) },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 36, ...endAt('zones-reflexes-podales', 24) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 27, slide: 37, ...endAt('zones-reflexes-podales', 27) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 38, ...endAt('zones-reflexes-podales', 30) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 39, ...endAt('zones-reflexes-podales', 33) },
