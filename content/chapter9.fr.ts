    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'sub', text: 'Reflux gastro-œsophagien, hernie hiatale' },
        {
          ...
          href: '/lecture/chapitre-8?xrefBack=%2Flecture%2Fchapitre-9%23p-pathologies-courantes-27&xrefBackLabel=Retour%20au%20chapitre%209#p-pathologies-courantes-diagnostic-d-exclusion-indications-troubles-fonctionnels-0',
        },
    ...
    },
    {
      ...
      blocks: [
        { type: 'sub', text: 'Syndrome général d\'adaptation' },
        {
          ...
          href: '/lecture/traitement-rop?xrefBack=%2Flecture%2Fchapitre-9%23p-zones-reflexes-podales-1&xrefBackLabel=Retour%20au%20chapitre%209#p-hierarchisation-3',
        },
        { type: 'bullets', items: [
        ...
        { type: 'figure', src: '/chapter-9/figure-9-articulations-costo-vertebrales.png', caption: 'Photo — Articulations costo-vertébrales', alt: 'Repère podal des articulations costo-vertébrales entre les deux pouces', orientation: 'landscape' },
        { type: 'sub', text: 'Syndrome loco-régional' },
        {
          type: 'xref',
          label: 'Voir la référence dans le chapitre 2',
          text: 'Zones réflexes occipitales et podales',
          href: '/lecture/traitement-rop?xrefBack=%2Flecture%2Fchapitre-9%23p-zones-reflexes-podales-4&xrefBackLabel=Retour%20au%20chapitre%209#p-hierarchisation-4',
        },
        { type: 'bullets', items: [
          'Estomac.',
        ...
        { type: 'figure', src: '/chapter-9/figure-9-hiatus-vagues.png', caption: 'Photo — Hiatus œsophagien et nerfs vagues droit et gauche', alt: 'Repère podal du hiatus œsophagien avec les nerfs vagues droit et gauche', orientation: 'landscape' },
        { type: 'figure', src: '/chapter-9/figure-9-petite-courbure.png', caption: 'Photo — Petite courbure de l’estomac', alt: 'Repère podal de la petite courbure de l’estomac entre cardia et pylore', orientation: 'landscape' },
        { type: 'sub', text: 'Système limbique' },
        {
          type: 'xref',
          label: 'Voir la référence dans le chapitre 2',
          text: 'Zones réflexes occipitales et podales',
          href: '/lecture/traitement-rop?xrefBack=%2Flecture%2Fchapitre-9%23p-zones-reflexes-podales-7&xrefBackLabel=Retour%20au%20chapitre%209#p-hierarchisation-5',
        },
