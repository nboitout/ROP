...
if (chapter9ReflexSection) chapter9ReflexSection.blocks = [
  ...
  { type: 'figure', src: '/chapter-9/cartographie/figure-9-01.png', caption: 'Photo : Nerf vague X dans la moelle allongée', alt: 'Repère podal du nerf vague X dans la moelle allongée', orientation: 'portrait' },
  { type: 'figure', src: '/chapter-9/cartographie/figure-9-02.png', caption: 'Photo : Nerf vague X dans le foramen jugulaire', alt: 'Repère podal du nerf vague X dans le foramen jugulaire', orientation: 'portrait' },
  { type: 'figure', src: '/chapter-9/cartographie/figure-9-04.png', caption: 'Photo : Hiatus œsophagien et nerfs vagues droit et gauche', alt: 'Repère podal du hiatus œsophagien avec les nerfs vagues droit et gauche', orientation: 'portrait' },
