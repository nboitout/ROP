...
export const chapter5SlidesEn: SyncSlide[] = [
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 1.png', title: 'Stress Mechanism' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 2.png', title: 'Homeostasis and Allostasis' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 3.png', title: 'Allostatic load: the cumulative cost of adaptation' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 4.png', title: 'The Stressor Triad' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 5.png', title: 'Stress is not the event; it is the response' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 6.png', title: 'The dual response to a stressor: emergency and support' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 7.png', title: 'General Adaptation Syndrome (GAS)' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 8.png', title: 'From alarm to recovery' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 9.png', title: 'Phase 3: Adaptation-Resistance' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 10.png', title: 'Phase 4: Decompensation or exhaustion' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 11.png', title: 'The true cost of stress: the absence of recovery' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 12.png', title: 'The Adaptive Challenge: Completing the Response' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 13.png', title: 'The cost of regulation: active mobilization, not a leaky reservoir' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 14.png', title: 'The cost of regulation and allostatic load' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 15.png', title: 'Cellular hypermetabolism under stress' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 16.png', title: 'The Threshold Model: Functional Disorder and Structural Alteration' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 17.png', title: 'The autonomic target: flexibility' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 18.png', title: 'The autonomic goal: flexibility, not vagal dominance' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 19.png', title: 'The ascending pathway (bottom-up): informing interoception' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 20.png', title: 'The ROP session: stimulate, then allow integration' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 21.png', title: 'The ROP Clinical Sequence: A Four-Level Progression' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 22.png', title: 'The ROP clinical sequence: a four-level progression' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 23.png', title: 'Level 1 — Regulation of Higher Centers' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 24.png', title: 'Level 2 — Autonomic regulation and adaptation' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 25.png', title: 'Level 3 — Locoregional Regulation' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 26.png', title: 'Level 4 — Visceral or functional target and integration' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 27.png', title: 'Fibromyalgia and Allostatic Load' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 28.png', title: 'Research directions: measuring recovery kinetics' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 29.png', title: 'Stress Mechanism: Neurological Response (SAM)' },
  { src: '/Chapter-5 Rework/EN/Images/NCH 5 EN IMG 30.png', title: 'Stress mechanism: hormonal axis (HPA)' },
]
...
export const chapter5SlideAnchorsEn: SyncAnchor[] = [
  ...
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 2, slide: 22 },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 3, slide: 23 },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 8, slide: 24 },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 13, slide: 25 },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 17, slide: 26 },
