...
export const chapter5SlidesEn: SyncSlide[] = [
  ...
  { src: '/chapter-5/EN/Images/NCH 5 EN IMG 23_V2.png', title: 'Level 1 — Regulation of Higher Centres' },
  ...
  { src: '/chapter-5/EN/Images/NCH 5 EN Occipital Cartography V2.png', title: 'ROP Cartography — Occipital Zones' },
...
export const chapter5SlideAnchorsEn: SyncAnchor[] = [
  { sectionId: 'le-stress-une-reponse-d-adaptation', blockIndex: -1, slide: 1, end: { sectionId: 'de-l-homeostasie-a-l-allostasie', blockIndex: -1 } },
  { sectionId: 'de-l-homeostasie-a-l-allostasie', blockIndex: -1, slide: 2, end: { sectionId: 'de-l-homeostasie-a-l-allostasie', blockIndex: 5 } },
  { sectionId: 'de-l-homeostasie-a-l-allostasie', blockIndex: 5, slide: 3, end: { sectionId: 'la-trilogie-des-stresseurs', blockIndex: -1 } },
  { sectionId: 'la-trilogie-des-stresseurs', blockIndex: -1, slide: 4, end: { sectionId: 'le-stress-n-est-pas-seulement-l-evenement-c-est-la-reponse', blockIndex: -1 } },
  { sectionId: 'le-stress-n-est-pas-seulement-l-evenement-c-est-la-reponse', blockIndex: -1, slide: 5, end: { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: -1 } },
  { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: -1, slide: 6, end: { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: -1 } },
  { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: 0, slide: 29, end: { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: 3 } },
  { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: 3, slide: 30, end: { sectionId: 'la-double-reponse-au-stresseur-urgence-et-soutien', blockIndex: 7 } },
  { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: -1, slide: 7, end: { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 1 } },
  { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 1, slide: 8, end: { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 6 } },
  { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 6, slide: 9, end: { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 9 } },
  { sectionId: 'le-syndrome-general-d-adaptation-un-modele-pedagogique', blockIndex: 9, slide: 10, end: { sectionId: 'le-veritable-cout-du-stress-l-absence-de-recuperation', blockIndex: -1 } },
  { sectionId: 'le-veritable-cout-du-stress-l-absence-de-recuperation', blockIndex: -1, slide: 11, end: { sectionId: 'le-veritable-cout-du-stress-l-absence-de-recuperation', blockIndex: 7 } },
  { sectionId: 'le-veritable-cout-du-stress-l-absence-de-recuperation', blockIndex: 7, slide: 12, end: { sectionId: 'le-cout-de-regulation-une-mobilisation-active-pas-une-batterie-qui-se-vide', blockIndex: -1 } },
  { sectionId: 'le-cout-de-regulation-une-mobilisation-active-pas-une-batterie-qui-se-vide', blockIndex: -1, slide: 13, end: { sectionId: 'le-cout-de-regulation-une-mobilisation-active-pas-une-batterie-qui-se-vide', blockIndex: 3 } },
  { sectionId: 'le-cout-de-regulation-une-mobilisation-active-pas-une-batterie-qui-se-vide', blockIndex: 3, slide: 14, end: { sectionId: 'a-l-echelle-cellulaire-le-prix-de-la-compensation', blockIndex: -1 } },
  { sectionId: 'a-l-echelle-cellulaire-le-prix-de-la-compensation', blockIndex: -1, slide: 15, end: { sectionId: 'le-modele-du-seuil-trouble-fonctionnel-et-alteration-structurelle', blockIndex: -1 } },
  { sectionId: 'le-modele-du-seuil-trouble-fonctionnel-et-alteration-structurelle', blockIndex: -1, slide: 16, end: { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: -1 } },
  { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: -1, slide: 17, end: { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: 1 } },
  { sectionId: 'la-cible-autonome-la-flexibilite-non-la-domination-vagale', blockIndex: 1, slide: 18, end: { sectionId: 'le-pont-avec-la-rop-agir-sur-la-reponse-non-sur-l-existence-du-stresseur', blockIndex: -1 } },
  { sectionId: 'le-pont-avec-la-rop-agir-sur-la-reponse-non-sur-l-existence-du-stresseur', blockIndex: -1, slide: 19, end: { sectionId: 'la-seance-rop-stimuler-puis-laisser-integrer', blockIndex: -1 } },
  { sectionId: 'la-seance-rop-stimuler-puis-laisser-integrer', blockIndex: -1, slide: 20, end: { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: -1 } },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: -1, slide: 21, end: { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 1 } },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 1, slide: [22, 23, 24, 25], end: { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 7 } },
  { sectionId: 'les-quatre-niveaux-rop-appliques-au-stress', blockIndex: 7, slide: 28, end: { sectionId: 'reactions-apres-seance-recuperation', blockIndex: -1 } },
  { sectionId: 'illustration-clinique-fibromyalgie-et-charge-allostatique', blockIndex: -1, slide: 26, end: { sectionId: 'vers-une-recherche-sur-la-cinetique-de-recuperation', blockIndex: -1 } },
  { sectionId: 'vers-une-recherche-sur-la-cinetique-de-recuperation', blockIndex: -1, slide: 27, end: { sectionId: 'conclusion', blockIndex: -1 } },
]
