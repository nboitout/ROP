...
export const chapter18ReworkSlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, itemIndex: 2, slide: [18, 19, 20] },
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, itemIndex: 0, slide: 21 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, itemIndex: 1, slide: 22 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, itemIndex: 1, slide: [23, 24, 25] },
]
