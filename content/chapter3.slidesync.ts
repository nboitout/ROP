...
export const chapter3Slides: SyncSlide[] = [
  ...
  { src: '/chapter-3/slides/slide-13.png', title: 'Mecanique vasculaire : le systeme porte hypothalamo-hypophysaire' },
  { src: '/chapter-3/slides/slide-14.png', title: 'L axe hypothalamo-hypophysaire : systeme porte' },
...
export const chapter3SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 40, slide: 9 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 48, slide: 10 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 52, slide: 11 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 60, slide: 12 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 68, slide: 13 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 70, slide: 14 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 75, slide: 15, gapBefore: 'half' },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 80, slide: 16 },

  { sectionId: 'section-4-zones-reflexes', blockIndex: 0, slide: 17 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 1, slide: 18 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 3, slide: 19 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 5, slide: 20 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 8, slide: 21 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 11, slide: 22 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 13, slide: 23 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 18, slide: 24, gapBefore: 'half' },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 19, slide: 25 },
]
