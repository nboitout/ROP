...
export const chapter3SlideAnchors: SyncAnchor[] = [
  { sectionId: 'section-1-presentation-generale', blockIndex: 0, slide: 1 },
  { sectionId: 'section-1-presentation-generale', blockIndex: 3, slide: 2 },
  ...
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 13, slide: 5 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 26, slide: 6 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 30, slide: 7 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 41, slide: 8 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 34, slide: 9 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 54, slide: 10 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 58, slide: 11 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 67, slide: 12 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 75, slide: 13 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 73, slide: 14 },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 38, slide: 15, gapBefore: 'half' },
  { sectionId: 'section-3-organisation-anatomique', blockIndex: 90, slide: 16 },

  { sectionId: 'section-4-zones-reflexes', blockIndex: 0, slide: 17 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 2, slide: 18 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 3, slide: 19 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 6, slide: 20 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 9, slide: 21 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 10, slide: 22 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 15, slide: 23 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 19, slide: 24, gapBefore: 'half' },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 21, slide: 25 },
]
