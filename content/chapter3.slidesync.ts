...
export const chapter3SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'section-4-zones-reflexes', blockIndex: 19, slide: 23 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 13, slide: 24 },
  { sectionId: 'section-4-zones-reflexes', blockIndex: 11, slide: 25 },
]
