...
export const chapter14Es: Chapter = {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'bullets', items: [
          'El intestino delgado es intraperitoneal.',
          'A la izquierda, el yeyuno recubre el colon descendente.',
          'A la derecha, el íleon deja libre el colon ascendente.',
          'Dorsalmente, el intestino delgado se relaciona con la pared abdominal posterior y los órganos retroperitoneales, en particular la parte suprameso-cólica del duodeno, los riñones, los uréteres y los colones ascendente y descendente.',
          'Ventralmente: el epiplón mayor (anteriormente gran epiplón).',
          'Caudalmente: los órganos pélvicos, sobre todo la vejiga.',
          'Cefálicamente: el mesocolon transverso.',
        ]},
      ],
    },
    {
