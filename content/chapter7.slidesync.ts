...
export const chapter7SlidesEn: SyncSlide[] = [
  ...
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 3 V2.png', title: 'The Three Visceral Spaces' },
  ...
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 9 V2.png', title: 'Dual Nervous Supply: Somatic and Autonomic' },
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 10 V2.png', title: 'Parietal–Visceral Physiology: The Role of Transversus Abdominis' },
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 11 V2.png', title: 'Dynamics of Peritoneal Fluid' },
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 12 V2.png', title: 'Peritoneal Pathology: Mechanisms and Clinical Features' },
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 13 V2.png', title: 'Map of Referred Pain' },
  { src: '/chapter-7/EN/IMAGES/NCH 7 EN IMG 14 V2.png', title: 'Synthesis — Container, Contents, and Peritoneal Networks' },
...
export const chapter7SlideAnchorsEn: SyncAnchor[] = chapter7SlideAnchors.map(({ end, ...anchor }) => ({
  ...anchor,
  ...(end ? { end: { ...end } } : {}),
}))
