...
export const chapter7SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 7, slide: 15, end: { sectionId: 'zones-reflexes-podales', blockIndex: 9 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 9, slide: 16, end: { sectionId: 'zones-reflexes-podales', blockIndex: 11 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 11, slide: 17, end: { sectionId: 'zones-reflexes-podales', blockIndex: 13 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 13, slide: 18, end: { sectionId: 'zones-reflexes-podales', blockIndex: 15 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, slide: 19, end: { sectionId: 'zones-reflexes-podales', blockIndex: 17 } },
]
