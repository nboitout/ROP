...
export const chapter14Slides: SyncSlide[] = [
  ...
  { src: '/chapter-14/slides/fr-rework/slide-09-motricite.png', title: 'Motricité de l’intestin grêle' },
...
export const chapter14SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'pathologies',    blockIndex: 16, slide: 17, gapBefore: 'half', end: { sectionId: 'pathologies', blockIndex: 18 } },
  { sectionId: 'pathologies',    blockIndex: 18, slide: 18 },
  ...
  { sectionId: 'relations',      blockIndex: 2,  slide: 27, end: { sectionId: 'relations', blockIndex: 7 } },
]
