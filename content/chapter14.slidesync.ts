...
export const chapter14SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'rop',            blockIndex: 12, slide: 19 },
  { sectionId: 'rop',            blockIndex: 13, slide: 20 },
  { sectionId: 'rop',            blockIndex: 14, slide: 21 },
  { sectionId: 'rop',            blockIndex: 15, slide: 22 },
  { sectionId: 'rop',            blockIndex: 16, slide: 23 },
  { sectionId: 'rop',            blockIndex: 24, slide: 24 },
  { sectionId: 'rop',            blockIndex: 25, slide: 25, end: { sectionId: 'rop', blockIndex: 26 } },
  { sectionId: 'relations',      blockIndex: 0,  slide: 18 },
  { sectionId: 'relations',      blockIndex: 2,  slide: 26, end: { sectionId: 'relations', blockIndex: 7 } },
]
