...
export const chapter14Slides: SyncSlide[] = [
  ...
  { src: '/chapter-14/cartographie/figure-14-07.png', title: 'Cartographie : Petite courbure de l’estomac' },
  { src: '/chapter-14/cartographie/figure-14-09.png', title: 'Cartographie : Parasympathique pelvien ou sacré' },
...
export const chapter14SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'pathologies',    blockIndex: 13, slide: 17 },
  { sectionId: 'pathologies',    blockIndex: 16, slide: 18, gapBefore: 'half' },
  { sectionId: 'rop',            blockIndex: -1, slide: 19 },
  { sectionId: 'rop',            blockIndex: 1,  slide: 20, gapBefore: 'half' },
  { sectionId: 'rop',            blockIndex: 4,  slide: 21 },
  { sectionId: 'rop',            blockIndex: 5,  slide: 22 },
  { sectionId: 'rop',            blockIndex: 6,  slide: 23 },
  { sectionId: 'rop',            blockIndex: 9,  slide: 24 },
  { sectionId: 'rop',            blockIndex: 10, slide: 25 },
  { sectionId: 'rop',            blockIndex: 14, slide: 26 },
  { sectionId: 'rop',            blockIndex: 15, slide: 27, end: { sectionId: 'rop', blockIndex: 16 } },
  { sectionId: 'relations',      blockIndex: 2,  slide: 28 },
]
