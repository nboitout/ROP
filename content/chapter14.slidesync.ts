...
export const chapter14SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'rop',            blockIndex: 13, slide: 19 },
  { sectionId: 'rop',            blockIndex: 14, slide: 20 },
  { sectionId: 'rop',            blockIndex: 15, slide: 21 },
  { sectionId: 'rop',            blockIndex: 16, slide: 22 },
  { sectionId: 'rop',            blockIndex: 17, slide: 23 },
  { sectionId: 'rop',            blockIndex: 25, slide: 24 },
  { sectionId: 'rop',            blockIndex: 26, slide: 25, end: { sectionId: 'rop', blockIndex: 27 } },
