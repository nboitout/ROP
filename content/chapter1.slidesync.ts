...
export const chapter1Slides: SyncSlide[] = [
  ...
  { src: '/chapter-1/FR/slides/slide-09.png', title: 'Biorythmes : variations cycliques utiles au diagnostic' },
  { src: '/chapter-1/FR/slides/slide-10.png', title: 'Les articulations viscérales' },
  { src: '/chapter-1/FR/slides/slide-11.png', title: 'Interstitium, séreuses et pressions' },
  { src: '/chapter-1/FR/slides/slide-12.png', title: 'Les moyens d’union : haubans et passages' },
...
export const chapter1SlidesEn: SyncSlide[] = [
  ...
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%205%20V2.png', title: 'Somatic mobility and visceral gliding' },
  ...
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%208%20V2.png', title: 'Motility: Intrinsic Movement and Clinical Assessment' },
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%209%20V2.png', title: 'Biorhythms: Cyclical Variations Useful for Diagnosis' },
  ...
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%2016%20V2.png', title: 'When Mobility Is Lost: Adhesions and Ptosis' },
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%2017.png', title: 'Reflex Spasms and Hypertonicity' },
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%2018%20V2.png', title: 'The ROP Clinical Approach: Return to Balance' },
  { src: '/chapter-1/EN/Images/NCH%201%20EN%20IMG%2019%20V2.png', title: 'Practical Summary' },
]
...
export const chapter1SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'mobilite-viscerale', blockIndex: 22, slide: 9, ...endAt('mrp', -1) },
  ...
  { sectionId: 'synthese-operationnelle', blockIndex: 0, slide: 19, ...endAt('synthese-operationnelle', 0) },
]
