...
export const chapter9SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'innervation', blockIndex: 3, slide: 9, end: { sectionId: 'innervation', blockIndex: 5 } },
  { sectionId: 'innervation', blockIndex: 9, slide: 10 },
  { sectionId: 'physiologie', blockIndex: 4, slide: 11 },
  { sectionId: 'physiologie', blockIndex: 18, slide: 12 },
  { sectionId: 'physiologie', blockIndex: 22, slide: 13 },
  { sectionId: 'pathologies-courantes', blockIndex: 0, slide: 14 },
  { sectionId: 'pathologies-courantes', blockIndex: 9, slide: 15 },
  { sectionId: 'pathologies-courantes', blockIndex: 11, slide: 16 },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 2, slide: 22, end: { sectionId: 'zones-reflexes-podales', blockIndex: 4 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 6, slide: 23, end: { sectionId: 'zones-reflexes-podales', blockIndex: 9 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 9, slide: 24, gapBefore: 'half' },
  { sectionId: 'zones-reflexes-podales', blockIndex: 11, slide: 25 },
]
