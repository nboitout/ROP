...
export const chapter9SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'indications-troubles-fonctionnels', blockIndex: 3, slide: 16 },
  { sectionId: 'indications-troubles-fonctionnels', blockIndex: 16, slide: 17 },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 31, slide: 21, end: { sectionId: 'zones-reflexes-podales', blockIndex: 33 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 16, slide: 22, end: { sectionId: 'zones-reflexes-podales', blockIndex: 21 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 23, end: { sectionId: 'zones-reflexes-podales', blockIndex: 26 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 24, gapBefore: 'half' },
  { sectionId: 'zones-reflexes-podales', blockIndex: 41, slide: 25 },
]
