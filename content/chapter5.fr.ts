  ...
  sections: [
    {
      ...
      title: 'Présentation',
      blocks: [
        { type: 'para', text: 'Stress est un mot constamment utilisé dans nos sociétés modernes : la compétition, la concurrence, la recherché de la performance nous poussent à aller toujours plus vite, avec le risque, si nous n’en prenons pas garde, que le stress nous submerge jusqu’à l’épuisement.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'para', text: 'Le mécanisme de stress est un phénomène protecteur fondamental de la vie auquel nous sommes tous soumis et pour lequel nous sommes biologiquement préparés. À court terme, le mécanisme de stress est protecteur en vue du retour à l’homéostasie. Quand il devient intense, durable et répétitif, il à un coût énergétique. Il peut affecter la vitalité et s’accompagne d’une diminution des capacités d’adaptation. L’organisme peut alors évoluer progressivement vers les pathologies fonctionnelles, puis, selon le terrain, vers les maladies chroniques ou dégénératives.' },
      ],
    },
    {
      id: 'stresseurs',
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'lead', label: 'Axe hormonal', text: 'sous l’action de l’hormone hypothalamique CRH, l’antéhypophyse libère l’ACTH qui stimule, à son tour, les glandes corticosurrénales. Cette cascade hormonale libère différentes hormones : cortisol, aldostérone et DHEA. C’est l’axe HHS ou corticotrope.' },
        { type: 'leadBullets', items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'lead', label: 'Syndrome locorégional', text: 'c’est une compression mécanique locale du système nerveux somatique ou autonome avec réténtissement secondaire général.' },
        { type: 'leadBullets', items: [
