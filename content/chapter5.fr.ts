  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-16.png', caption: 'Photo : Parasympathique pelvien ou sacré', alt: 'Repère podal du parasympathique pelvien ou sacré', orientation: 'landscape' },
        { type: 'para', text: 'Nerf phrénique : C3-C4-C5 et Triangle de Sédillot.' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-18.png', caption: 'Photo : Nerf phrénique (C3-C4-C5)', alt: 'Repère podal du nerf phrénique C3-C4-C5', orientation: 'landscape' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-20.png', caption: 'Photo : Nerf phrénique (triangle de Sédillot)', alt: 'Repère podal du nerf phrénique au triangle de Sédillot', orientation: 'landscape' },
