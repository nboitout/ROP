  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'para', text: 'Système limbique, diencéphale, tronc cérébral, hypophyse, surrénales (axe HHS).' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-04.png', caption: 'Photo : Tronc cérébral', alt: 'Repère podal du tronc cérébral', orientation: 'portrait' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-06.png', caption: 'Photo : Amygdale du cerveau limbique', alt: 'Repère podal de l’amygdale du cerveau limbique', orientation: 'portrait' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-08.png', caption: 'Photo : Diencéphale', alt: 'Repère podal du diencéphale', orientation: 'portrait' },
        { type: 'para', text: 'Nerfs crâniens : Jumeau V, Vague X, Hypoglosse XI, C2 et C3.' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-10.png', caption: 'Photo : Sinus et glomus carotidien', alt: 'Repère podal du sinus et du glomus carotidien', orientation: 'portrait' },
        ...
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-12.png', caption: 'Photo : Nerf vague X dans le foramen jugulaire', alt: 'Repère podal du nerf vague X dans le foramen jugulaire', orientation: 'portrait' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-14.png', caption: 'Photo : Nerfs vagues au hiatus œsophagien', alt: 'Repère podal des nerfs vagues au hiatus œsophagien', orientation: 'portrait' },
        { type: 'para', text: 'Colonne vertébrale : systèmes sympathique C8 à L2 et parasympathique pelvien S2 à S4.' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-16.png', caption: 'Photo : Parasympathique pelvien ou sacré', alt: 'Repère podal du parasympathique pelvien ou sacré', orientation: 'portrait' },
        { type: 'para', text: 'Nerf phrénique : C3-C4-C5 et Triangle de Sédillot.' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-18.png', caption: 'Photo : Nerf phrénique (C3-C4-C5)', alt: 'Repère podal du nerf phrénique C3-C4-C5', orientation: 'portrait' },
        { type: 'figure', src: '/chapter-5/slides/cartographie-fr/slide-20.png', caption: 'Photo : Nerf phrénique (triangle de Sédillot)', alt: 'Repère podal du nerf phrénique au triangle de Sédillot', orientation: 'portrait' },
