  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'figure', src: '/chapter-5/figure-5-13.png', alt: 'Territoires crânien et cervical du nerf Vague X (en jaune)', caption: 'Figure 5.13 — Territoires crânien et cervical du nerf Vague X (jaune)', orientation: 'portrait' },
        ...
        { type: 'figure', src: '/chapter-5/figure-5-16.png', alt: 'Territoire abdominal gauche du nerf Vague X (en jaune)', caption: 'Figure 5.16 — Territoire abdominal gauche du nerf Vague X (jaune)', orientation: 'portrait' },
