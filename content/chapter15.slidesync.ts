...
export const chapter15SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'anatomie', blockIndex: 11, slide: 5 },
  { sectionId: 'anatomie', blockIndex: 18, slide: 6 },
  { sectionId: 'anatomie', blockIndex: 22, slide: 7 },
  ...
  { sectionId: 'pathologies-courantes', blockIndex: 1, slide: 16 },
  { sectionId: 'pathologies-courantes', blockIndex: 3, slide: 17 },
  { sectionId: 'pathologies-courantes', blockIndex: 5, slide: 18 },
  { sectionId: 'pathologies-courantes', blockIndex: 9, slide: 19 },
  { sectionId: 'pathologies-courantes', blockIndex: 11, slide: 20 },
  { sectionId: 'pathologies-courantes', blockIndex: 13, slide: 21 },
  { sectionId: 'pathologies-courantes', blockIndex: 15, slide: 22 },
  { sectionId: 'pathologies-courantes', blockIndex: 17, slide: 23 },
  { sectionId: 'pathologies-courantes', blockIndex: 19, slide: 24 },
  { sectionId: 'pathologies-courantes', blockIndex: 21, slide: 25 },
  { sectionId: 'pathologies-courantes', blockIndex: 23, slide: 26 },
  { sectionId: 'pathologies-courantes', blockIndex: 25, slide: 27 },
  { sectionId: 'pathologies-courantes', blockIndex: 27, slide: 28 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 2, slide: 29 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 3, slide: 30 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 5, slide: 31 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 7, slide: 32 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 8, slide: 33 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 34 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 20, slide: 35 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 22, slide: 36 },
]
