      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Rectorragies;",
            "Méléna (sang noir digéré, dû à une hémorragie digestive haute (estomac, intestin grêle proximal);",
            "Fièvre;",
            "Alternance inhabituelle de constipation et de diarrhée;",
            "Constipation durable et inhabituelle;",
            "Ecoulement de liquides troubles par voie anale;",
            "Douleur abdominale forte;",
            "Amaigrissement, anémie;",
            "Altération de l’état général;",
            "Polypes colorectaux, parfois avec des saignements de sans rouge. Ils sont susceptibles de cancérisation et de métastases vers le foie et les poumons;",
            "Complications de diverticules: inflammation ou infection de plusieurs diverticules (diverticulite, sigmoïdite);",
            "Cancer colorectal: redouté et 2ème cause de décès par cancer en France. Les symptômes se manifestent le plus souvent dans le sigmoïde. Parmi les causes, citons le caractère génétique.",
            "Iléus mécanique; obstruction entraînant hyperpéristaltisme et météorisme luttant contre l’obstacle;",
            "Rectocolite hémorragique (RCH): inflammation de la muqueuse, touchant le côlon, mais surtout le rectum. Les causes sont mystérieuses. Le risque de cancérisation est possible sur les RCH anciennes.",
            "Indications: pathologies fonctionnelles:",
            "Constipation: c’est une atonie colique entraînant un retard dans l’exonération des selles. On distingue les constipations distales et proximales:",
            ...
            "Les personnes qui ont une insuffisance de sangle abdominale ou une ptose périnéale;",
            "Les femmes qui ont vécu un accouchement difficile avec déchirure du périnée;",
            "Les personnes qui prennent des anxiolytiques, antidépresseurs, calmants.",
            "Iléus paralytique: perturbation fonctionnelle du transit par sidération et atonie du péristaltisme intestinal, sans obstacle mécanique par tumeur ou bride cicatricielle. Il se caractérise par l’arrêt incomplet des matières et des gaz à la suite de l’anesthésie et de la chirurgie abdominale.",
            "Symptômes associés:",
            "Gêne et sensation de mal-être et douleur;",
            "Epreinte: c’est une douleur spasmodique du sigmoïde ou du rectum donnant des fausses envies ou des envies impérieuses;",
            "Ténesme: sensation de tension de l’anus, provoquant une envie d’aller à la selle."
          ]
        },
        {
          "type": "sub",
        ...
        },
        {
          "type": "bullets",
          "items": [
            "Fécalome: en cas de constipation persistante, les selles sont sèches et dures par réabsorption d’eau. Une volumineuse masse de matières fécales dures, stagnant dans le rectum, forme un fécalome. Les selles dures, en stagnant, dilatent le rectum et les mécano-récepteurs ne sont plus stimulés et n’envoient plus d’information à la moelle épinière et au cerveau: le réflexe de défécation est inhibé.",
            "Thrombose hémorroïdaire. Quand les selles stagnent trop longtemps, la tension de la paroi du rectum freine la circulation veineuse. Les veines hémorroïdales se dilatent et créent un œdème. Il se forme un caillot: c’est la thrombose hémorroïdale communément appelée « crise hémorroïdaire ». Elle se manifeste par une douleur aigüe au rectum, provoquée par le frottement des veines contre la paroi rectale ou les matières fécales.",
        ...
        {
          "type": "sub",
          "text": "Les colopathies fonctionnelles ont en commun"
        },
        {
          "type": "bullets",
          "items": [
            "troubles du transit: ballonnements, transit alternant constipation-diarrhée;",
