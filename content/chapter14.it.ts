  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'lead', label: 'Muscolo di Treitz', text: 'partecipa al mantenimento dell\'angolo duodigiuno-digiunale mediante la sua contrazione, portando la radice del mesentere verso l\'alto e a sinistra.' },
        { type: 'para', text: 'Favorendo una tensione longitudinale, partecipa allo svuotamento del contenuto duodenale nel digiuno. La radice del mesentere fornisce la vascolarizzazione e l\'innervazione all\'intestino tenue.' },
        { type: 'figure', src: '/chapter-14/it/Chapter14 Fig4 IT.png', caption: 'Figura 14.4 — Muscolo di Treitz', alt: 'Muscolo di Treitz e angolo duodigiuno-digiunale', orientation: 'landscape', syncHide: true },
        { type: 'rop', body: [
