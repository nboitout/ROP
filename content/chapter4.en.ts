  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { type: "para", text: "In Chapter 1, General Principles, we emphasized the importance of visceral mobility. This mobility depends largely on the proper functioning of the two components of the autonomic nervous system (ANS): the parasympathetic and sympathetic systems. (Figure 4.1)" },
    ...
    },
    {
      ...
      blocks: [
        { type: "para", text: "The cranial parasympathetic system is distinguished from the pelvic, or sacral, parasympathetic system. (Figure 4.2)" },
        ...
        { type: "leadBullets", items: [
          ...
          { label: "Course", text: "the parasympathetic fibers follow the course of the following cranial nerves. (Figure 4.2)" },
          ...
          { label: "Termination", text: "pre-visceral plexuses of the organs of the head. Cranial parasympathetic fibers, together with sympathetic fibers arising from the cervical ganglia and the laterovertebral thoracic ganglia from C8 to T2 or T3, form the pre-visceral plexuses of the organs of the head. (Figure 4.1)" },
        ...
        { type: "lead", label: "Plantar reflex zones", text: "plantar surface of the toes (base of the skull). (Figure 4.3)" },
        ...
        { type: "leadBullets", items: [
          { label: "Brainstem", text: "medial border of the distal phalanx of the hallux. (Figure 4.4)" },
        ...
        { type: "leadBullets", items: [
          { label: "Origin", text: "the motor cells originate in the dorsal nucleus and the ambiguus, or ventral, nucleus (Figure 4.5), located in the medulla oblongata at the level of the foramen magnum. They are connected to the hypothalamus, the olfactory system, the limbic system, the glossopharyngeal nerve (IX), and the accessory nerve (XI)." },
        ...
        { type: "lead", label: "Cranial course — jugular foramen", text: "the vagus nerve exits the skull through the jugular foramen together with the glossopharyngeal nerve (IX), accessory nerve (XI), internal jugular vein, and posterior meningeal artery. (Figure 4.6)" },
        ...
        { type: "lead", label: "Plantar reflex zones", text: "(Figure 4.3)" },
        { type: "leadBullets", items: [
          { label: "Medulla oblongata", text: "medial surface of the interphalangeal joint of the hallux. (Figure 4.7)" },
          { label: "Jugular foramen, superior and inferior ganglia", text: "proximal interphalangeal joint of the 4th and 5th toes, on the lateral side of the 4th toe and the medial side of the 5th toe. (Figure 4.8)" },
        ]},
        ...
        { type: "lead", label: "Cervical level", text: "in the neck, the vagus nerve descends within the carotid sheath (Figure 4.9), then anastomoses with the superior and inferior cervical sympathetic ganglia." },
        ...
        { type: "leadBullets", items: [
          ...
          { label: "Carotid sinus nerves", text: "the vagus nerve and glossopharyngeal nerve innervate the sinus, located at the carotid bifurcation at the level of C4. (Figure 4.10)" },
        ]},
