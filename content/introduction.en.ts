...
// Source: public/chapter-0/Chapter0 Introduction EN.docx
  ...
  sections: [
    {
      ...
      title: "Foreword",
      blocks: [
        { type: 'para', text: "This third volume of Réflexothérapie Occipito-Podale (ROP) is the natural continuation of the two preceding volumes. After the osteo-musculo-articular system in Volume 1 and the neuromeningeal system in Volume 2, we now turn to the field of the abdomino-pelvic viscera, the autonomic nervous system, and the mechanisms of stress." },
        { type: 'para', text: "The ambition remains the same: to provide a coherent mapping, aligned with anatomy and physiology, conceived three-dimensionally, with the body represented as an infant in the fetal position within the foot, and articulated with the occipital reflex zones. Together, the occipital and plantar reflex zones constitute the ROP Reflex Zones." },
      ],
    },
    {
      id: "en-bref",
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          "Clinical landmarks and a palpatory rationale for locating the ROP Reflex Zones on the soles of the feet, despite the limited bony landmarks available on the plantar surface.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'bullets', items: [
          ...
          "correlation with clinical reality, including patient history, imaging findings, and surgical observations.",
        ]},
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'bullets', items: [
          ...
          "ROP Reflex Zones — plantar mapping (general syndrome; locoregional syndrome).",
