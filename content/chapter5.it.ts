    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "rop", body: [
          ...
          "In questo modello, tali reazioni sono interpretate alla luce della legge di Hering, secondo la quale i sintomi evolvono verso la guarigione quando procedono:",
          "• Dall’alto verso il basso.",
          "• Dall’interno verso l’esterno.",
          "• Dal cronico verso l’acuto.",
          "• Ripercorrendo fasi precedenti della malattia.",
          ...
          "La tecnica di massaggio in ROP può essere scomposta in tre tempi:",
          "• Diagnosi tissutale.",
          "• Stimolazione della zona.",
          "• Tempo del “non fare nulla e lasciar accadere”.",
          "Essa è coerente con la regola già formulata dal fondatore dell’osteopatia, il Dr. A. T. Still: “trovalo, correggilo e lascialo stare” (“find it, fix it and leave it alone”).",
        ]},
