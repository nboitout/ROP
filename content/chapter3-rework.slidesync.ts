...
export const chapter3ReworkSlideAnchors = [
  ...
  { sectionId: 'zones-reflexes-rop', blockIndex: 8, slide: 19, gapBefore: 'half' as const, ...endAt('zones-reflexes-rop', 8) },
  { sectionId: 'zones-reflexes-rop', blockIndex: 11, slide: 20, ...endAt('zones-reflexes-rop', 11) },
  { sectionId: 'zones-reflexes-rop', blockIndex: 14, slide: 21, ...endAt('zones-reflexes-rop', 14) },
  { sectionId: 'zones-reflexes-rop', blockIndex: 17, slide: 22, ...endAt('zones-reflexes-rop', 20) },
]
