    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "rop", body: [
          ...
          "Diese Reaktionen werden in diesem Ansatz im Licht der Heringschen Regel interpretiert: Symptome einer Krankheit bewegen sich in Richtung Heilung, wenn sie:",
          "• von oben nach unten verlaufen.",
          "• von innen nach außen verlaufen.",
          "• vom Chronischen zum Akuten verlaufen.",
          "• frühere Krankheitsphasen erneut durchlaufen.",
          ...
          "Die ROP-Massagetechnik kann in drei Zeiten gegliedert werden:",
          "• Gewebediagnostik.",
          "• Stimulation der Zone.",
          "• Zeit des „Nichtstuns und Geschehenlassens“.",
          "Sie entspricht damit jener Regel, die bereits der Begründer der Osteopathie, Dr. A. T. Still, formulierte: „Find it, fix it and leave it alone.“",
        ]},
