...
export const chapter20SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 11, slide: 14, end: { sectionId: 'zones-reflexes-podales', blockIndex: 11 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 16, slide: 21, end: { sectionId: 'zones-reflexes-podales', blockIndex: 16 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 17, slide: 22, end: { sectionId: 'zones-reflexes-podales', blockIndex: 17 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 17, end: { sectionId: 'zones-reflexes-podales', blockIndex: 24 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 25, slide: 18, end: { sectionId: 'zones-reflexes-podales', blockIndex: 25 } },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 47, slide: 23, end: { sectionId: 'zones-reflexes-podales', blockIndex: 47 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 62, slide: 15, end: { sectionId: 'zones-reflexes-podales', blockIndex: 62 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 63, slide: 16, end: { sectionId: 'zones-reflexes-podales', blockIndex: 63 } },
]
