...
export const chapter20Slides: SyncSlide[] = [
  ...
  { src: '/chapter-20/slides/slide-03.png', title: 'Migration embryonnaire et correspondances reflexes' },
  ...
  { src: '/chapter-20/slides/slide-06.png', title: 'Mecaniques herniaires' },
  { src: '/chapter-20/slides/slide-07.png', title: 'Complexe prostatique et fluide seminal' },
  { src: '/chapter-20/slides/slide-08.png', title: 'Uretre prostatique et carrefour uro-genital' },
  { src: '/chapter-20/slides/slide-09.png', title: 'Hemodynamique et stase veineuse' },
  { src: '/chapter-20/slides/slide-10.png', title: 'Cablage nerveux et vasculaire' },
  { src: '/chapter-20/slides/slide-11.png', title: 'Matrice diagnostique des pathologies' },
  { src: '/chapter-20/slides/slide-12.png', title: 'Dissonance mecanique : effet cascade de l HBP' },
  { src: '/chapter-20/slides/slide-13.png', title: 'Dimension psycho-emotionnelle' },
  { src: '/chapter-20/slides/slide-14.png', title: 'Synthese therapeutique ROP' },
  { src: '/chapter-20/slides/slide-15.png', title: 'Synthese pratique ROP : cartographie du protocole' },
