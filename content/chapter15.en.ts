...
// Faithful English translation of the authoritative final French Chapter 15 runtime.
// Source alignment: 403 FR/EN DOCX paragraphs; block structure follows chapter15.fr.ts.
export const chapter15En: Chapter = {
  slug: "chapter-15",
  number: "15",
  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Function of the vermiform appendix: it is a lymphoid organ that provides a protected reservoir of commensal bacteria that are beneficial to the host (see Microbiota). These organisms help to counter pathogenic bacteria, particularly in individuals living in contaminated environments or whose living conditions are unhygienic.",
        ...
        },
        {
          type: "rop",
          body: [
            "Any caecal adhesion following appendicectomy, a functional colonic disorder, or an irritable or spastic colon may restrict caecal mobility and, within this clinical model, contribute to a caecoileal reflex, fixation of the right sacroiliac joint and referred pain in the right lower limb.",
        ...
        },
        {
          type: "bullets",
          items: [
            "The ascending colon runs obliquely upwards and posteriorly. It is superficial, related to the anterior abdominal wall and not covered by the ileum. It is retroperitoneal and attached to the posterior abdominal wall by Toldt’s fascia.",
          ],
        },
        {
          type: "rop",
        ...
        },
        {
          type: "bullets",
          items: [
            "3.3. Right colic flexure (hepatic flexure)",
            ...
            "The transverse colon successively occupies the right hypochondriac, epigastric and left hypochondriac regions. It runs obliquely upwards and to the left. Its middle portion lies closer to the anterior abdominal wall than the more deeply situated right and left colic flexures.",
            "The transverse mesocolon is a fold of peritoneum that connects the transverse colon to the posterior abdominal wall through its root.",
            "Root of the transverse mesocolon: it forms a partition dividing the abdominal cavity into two compartments. See Chapter 1, General Principles: Visceral Articulations.",
        ...
        },
        {
          type: "bullets",
          items: [
            "Left colic flexure (splenic flexure): it is more acute, with an average angle of 50°, and lies in a sagittal plane.",
          ],
        },
        {
          type: "para",
        ...
        },
        {
          type: "rop",
          body: [
            "The splenic flexure of the colon should be considered in conjunction with the diaphragm and spleen.",
          ],
        },
        {
          type: "bullets",
        ...
        },
        {
          type: "rop",
          body: [
            "Within the ROP framework, adhesions involving the descending colon, psoas and lumbar plexus may contribute to left-sided lumbar and sacroiliac pain.",
          ],
        },
        {
          type: "bullets",
          items: [
            ...
            "Sigmoid mesocolon: this inverted V-shaped fold of peritoneum has its apex near the division of the left common iliac artery into the internal and external iliac arteries, at the level of the left sacroiliac joint. Its two roots connect the sigmoid colon to the posterior abdominal wall (Figure 15.7).",
        ...
        },
        {
          type: "rop",
          body: [
            "The rich neurovascular network of the sigmoid mesocolon is considered highly reflexogenic within this model, supporting assessment and stimulation of its reflex zone.",
          ],
        },
        {
          type: "bullets",
          items: ["Rectum (meaning straight):"],
        },
        {
          type: "para",
        ...
        },
        {
          type: "bullets",
          items: [
            "It is initially retroperitoneal and then subperitoneal. It lies anterior to the sacrum and posterior to the rectouterine pouch in women (pouch of Douglas) or the rectovesical pouch in men.",
            ...
            "Anal canal: the rectum passes through the pelvic diaphragm and terminates at the anus (Figure 15.8). The anal canal is approximately 4 cm long and contains two sphincters:",
            "Internal sphincter: it is formed by smooth muscle continuous with the rectum and is controlled by the pelvic parasympathetic and sympathetic pathways from T12 to L1. See Chapter 17, Pelvic Cavity: Innervation.",
            "External sphincter: it is a ring of striated muscle supplied by the pudendal nerve of the somatic nervous system (see Chapter 17, Pelvic Cavity: Innervation). It controls anal continence and is reinforced by the levator ani muscle.",
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          type: "bullets",
          items: [
            "Caecum: its anatomical relationships are:",
            ...
            "Ascending colon: its anatomical relationships are:",
            ...
            "Anteriorly: the anterior abdominal wall;",
            "Right colic flexure: its anatomical relationships are:",
            ...
            "Splenic flexure: its anatomical relationships are:",
            ...
            "Descending colon: its anatomical relationships are:",
            ...
            "Sigmoid colon: its anatomical relationships are:",
            ...
            "The rectum occupies the most posterior part of the visceral compartment of the pelvic cavity.",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "bullets",
          items: [
            "Superior mesenteric artery: it supplies the ascending colon and the proximal two thirds of the transverse colon. See Chapter 14, Small Intestine: Vascular Supply.",
        ...
        },
        {
          type: "bullets",
          items: [
            "Inferior mesenteric vein: it drains the descending colon, left colic flexure, sigmoid colon and upper rectum, and most commonly joins the splenic vein. The splenic and superior mesenteric veins unite to form the portal vein (Figure 11.5), which enters the liver. Rectal venous drainage is mixed: the upper rectum drains into the portal system, whereas the middle and lower rectum communicate with the caval system through the internal iliac veins.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "rop",
          body: [
            "In any case of left-sided low back pain with sciatica, it is important to assess the reflex zones of the rectosigmoid region, liver, left kidney and left renal vein, into which the left lumbar vein drains. See Chapter 16, Kidney.",
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Cannon-Böhm zone: this is not a discrete anatomical region but a neurovascular junction (Figure 4.20) comprising:",
        ...
        },
        {
          type: "rop",
          body: [
            "The reflex zone corresponding to the Cannon-Böhm transition is important to assess in disorders of the small intestine and colon.",
          ],
        },
        {
          type: "bullets",
          items: [
            "Intrinsic innervation is provided by the enteric nervous system. See Chapter 4, Autonomic Nervous System.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          ...
          items: [
            ...
            "Sympathetic action: contraction, maintenance of tone and relative dryness of the rectal mucosa.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "In the sigmoid colon, contractions become more frequent and signal the urge to defaecate.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Internal sphincter: it consists of smooth muscle fibres. When the rectum is empty, sympathetic activity keeps the internal sphincter closed and ensures anal continence. This contraction is involuntary. Intrarectal pressure is lower than internal sphincter pressure, allowing faeces to be stored in the rectal ampulla without an immediate urge to defaecate.",
            ...
            "External sphincter: it forms the final barrier before stool is passed. It is supplied by the pudendal nerve and is under voluntary control. Toilet training teaches the child to control the external sphincter; later, the individual may choose either to respond immediately to the urge to defaecate or to defer it. Central control is mediated by the ascending frontal gyrus through the pyramidal tract.",
          ],
        },
        {
          type: "para",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "bullets",
          items: [
            "Bright red blood in the stool or black stools.",
            "Fever, unusual fatigue, weight loss or anaemia.",
            "Severe abdominal pain or deterioration in general health.",
            "New, persistent constipation or a marked change from the usual pattern.",
            "An unusual alternation between constipation and diarrhoea.",
            "Abnormal anal discharge.",
            "These signs require medical assessment to exclude a serious underlying cause.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Some gastrointestinal disorders result from identifiable disease of the colon.",
            "Polyps are generally benign, although some may progress over time.",
            "Diverticula may become inflamed or infected, causing diverticulitis, including sigmoid diverticulitis.",
            "Ulcerative colitis is a chronic inflammatory disease of the colon and rectum.",
            "Colorectal cancer must be considered when red-flag symptoms are present.",
            "Intestinal obstruction may prevent normal transit and requires medical management.",
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          type: "bullets",
          items: [
            "Regular bowel function depends on several simple habits.",
            "Adequate fluid intake helps to keep stools soft.",
            "Dietary fibre increases stool bulk and promotes its progression.",
            "Physical activity naturally stimulates intestinal motility.",
            "Stress may slow or disrupt bowel transit.",
            "A regular routine helps the body re-establish its natural rhythm.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Insufficient fluid and fibre intake and lack of physical activity promote constipation.",
            "Some foods may slow bowel transit, including chocolate, bananas or rice, depending on the individual.",
            "Fibre-rich foods may be helpful, including fruit, vegetables, pulses and wholemeal bread.",
            "Fibre is beneficial only when fluid intake is adequate.",
            "Chronic stress may reduce digestive activity.",
            "Lifestyle habits therefore contribute directly to bowel comfort and regularity.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Regularly suppressing the urge to defaecate may diminish the natural reflex.",
            "Rectal sensitivity may decline with age.",
            "Weakness of the abdominal wall or pelvic floor may make evacuation more difficult.",
            "A difficult delivery may alter this balance.",
            "Some medicines may also slow or disrupt bowel transit.",
            "The longer stool remains in the colon, the harder it becomes and the more difficult it is to pass.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Constipation may predominantly affect the right or left side of the colon.",
            "Proximal constipation principally affects the beginning of the colon, near the caecum.",
            "Distal constipation principally affects the terminal portion: the descending colon, sigmoid colon and rectum.",
            "This distinction can help to clarify the symptoms experienced.",
            "It does not replace medical diagnosis when symptoms are unusual or persistent.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Stool transit is slower in the proximal colon.",
            "The right iliac fossa may be tender in some individuals.",
            "Prolonged stasis may be associated with bloating, dyspepsia or halitosis.",
            "Some individuals also report headache or a sensation of heaviness.",
            "Dietary adjustment, adequate hydration and physical activity are appropriate first-line measures.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "The gastrocolic reflex produces the urge to defaecate after a meal.",
            "It is often most pronounced in the morning, after breakfast.",
            "When gastric emptying is delayed, this reflex may be less effective.",
            "This may contribute to slower bowel transit.",
            "Hepatobiliary or pancreatic disorders may also influence digestion and bowel transit.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "The brain, stress-response systems and gastrointestinal tract communicate continuously.",
            "Stress may directly inhibit intestinal motility.",
            "The stomach helps to trigger the gastrocolic reflex.",
            "Bile supports digestion and contributes to normal bowel transit.",
            "The liver, gallbladder and pancreas therefore contribute to overall digestive balance.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Faeces accumulate mainly in the descending colon, sigmoid colon or rectum.",
            "This may cause a sensation of blockage or incomplete evacuation.",
            "It is sometimes better tolerated than proximal constipation.",
            "Faeces may remain lodged before evacuation.",
            "Persistent constipation warrants assessment, particularly when it is recent or unusual.",
          ],
        },
        {
          type: "sub",
          text: "9.4. Rectal colic (épreinte) and tenesmus",
        },
        {
          type: "bullets",
          items: [
            "Rectal colic (épreinte) is characterised by spasmodic pain in the lower abdomen or rectum.",
            "It may cause a false or urgent desire to defaecate.",
            "Tenesmus is a sensation of tension or pressure at the anus.",
            "It produces the feeling of needing to defaecate, sometimes without meaningful relief.",
            "These symptoms may be accompanied by discomfort, malaise or abdominopelvic pain.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "When faeces remain in the rectum for too long, they may form a faecal impaction.",
            "A faecal impaction is a mass of very hard stool that is difficult to evacuate.",
            "Stasis may also precipitate an acute haemorrhoidal episode.",
            "Haemorrhoidal thrombosis is the formation of a clot within a haemorrhoidal vein.",
            "It may cause acute anorectal pain.",
            "Persistent constipation should therefore not be dismissed.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Colitis is inflammation of the colon and must be medically confirmed.",
            "Irritable bowel syndrome commonly combines abdominal pain, bloating and altered bowel habit without visible structural disease.",
            "Spastic colon describes a sensitive, reactive colon.",
            "Stress, cold exposure, meals or certain foods may exacerbate symptoms.",
            "Alternating constipation and diarrhoea may occur.",
            "Diagnosis is based on symptoms, clinical examination and the exclusion of organic disease.",
          ],
        },
        {
          type: "sub",
        ...
        },
        {
          type: "bullets",
          items: [
            "Digestive discomfort may cause bloating, pain and anxiety.",
            "Anxiety heightens attention to gastrointestinal sensations.",
            "This tension may promote spasm and disrupt bowel transit.",
            "The symptoms may then perpetuate stress, fatigue and a reduced sense of well-being.",
            "Low back or sacroiliac pain may sometimes accompany this presentation.",
            "The objective is to break this cycle by addressing bowel transit, lifestyle habits and stress regulation.",
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        {
          type: "para",
          text: "Within the ROP framework, it is difficult to differentiate the colon from the small intestine at the emotional level.",
        },
        {
          type: "para",
          text: "Stress and an anxious disposition may nevertheless affect digestive motility, visceral sensitivity and the attention paid to bodily sensations, thereby helping to perpetuate the symptoms of some functional colonic disorders.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "figure",
          src: "/chapter-15/EN/Cartography/figure-15-02.png",
          caption: "Photo: Ascending Colon and Transverse Colon",
          alt: "Foot treatment gesture for the ascending colon and transverse colon",
        ...
        {
          type: "para",
          text: "According to the assessment findings, evaluation may include:",
        },
        {
          type: "bullets",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "• Ascending colon.",
            "• Right colic flexure.",
            "• Relationships with the ileum, right kidney, liver and diaphragm, according to the assessment findings.",
          ],
        },
        {
          type: "figure",
          src: "/chapter-15/EN/Cartography/figure-15-04.png",
          caption: "Photo: Ileocecal Valve",
          alt: "Foot treatment landmark for the ileocecal valve",
          orientation: "portrait",
        },
        {
          type: "sub",
        ...
        {
          type: "figure",
          src: "/chapter-15/EN/Cartography/figure-15-06.png",
          caption: "Photo: Transverse Mesocolon Root — First Segment",
          alt: "Foot treatment landmark for the first segment of the transverse mesocolon root",
          orientation: "portrait",
        },
        {
          type: "figure",
          src: "/chapter-15/EN/Cartography/figure-15-08.png",
          caption: "Photo: Transverse Mesocolon Root — Second Segment",
          alt: "Foot treatment landmark for the second segment of the transverse mesocolon root",
        ...
        },
        {
          ...
          items: [
            ...
            "• Descending colon.",
            "• Sigmoid colon.",
            "• Sigmoid mesocolon and its roots, according to the assessment findings.",
            "• Relationships with the left psoas, left kidney and pelvis, where relevant.",
          ],
        },
        {
          type: "figure",
          src: "/chapter-15/EN/Cartography/figure-15-10.png",
          caption: "Photo: Mesosigmoid Roots",
          alt: "Foot treatment landmark for the mesosigmoid roots between the two index fingers",
          orientation: "landscape",
        },
        {
          type: "sub",
        ...
        {
          type: "sub",
          text: "13.6. Associated support areas according to the assessment findings",
        },
        {
          type: "bullets",
          items: [
        ...
        },
        {
          type: "bullets",
          items: [
            "• Proximal constipation: right colon + proximal Level 2 + abdominal module according to the assessment findings.",
        ...
        },
        {
          ...
          body: [
            "SAFETY PRINCIPLE - Any bleeding, recent and persistent change in bowel habit, weight loss, fever, anaemia or unusual pain requires appropriate medical assessment.",
          ],
        },
      ],
    },
