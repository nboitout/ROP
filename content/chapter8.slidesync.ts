...
export const chapter8SlidesEn: SyncSlide[] = [
  ...
  { src: '/chapter-8/EN/Images/NCH 8 EN IMG 6.png', title: 'Anatomy of the Diaphragm and Its Openings' },
  ...
  { src: '/chapter-8/EN/Images/NCH 8 EN IMG 7.png', title: 'Vascular Supply of the Diaphragm' },
  ...
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 17 V3.png', title: 'Left Diaphragmatic Dome and Oesophageal Hiatus' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 18 V3.png', title: 'Right Diaphragmatic Dome' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 19 V3.png', title: 'Oesophageal Hiatus' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 20 V3.png', title: 'Marfan and Larrey Hiatuses' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 21 V3.png', title: 'Phrenic Nerve' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 22 V3.png', title: 'Costovertebral Joints' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 23 V3.png', title: 'Azygos–Caval Junction' },
  { src: '/chapter-8/EN/Cartography/NCH 8 EN IMG 24 V3.png', title: 'Hyrtl Intercostobrachial Nerve' },
]
...
export const chapter8SlideAnchorsEn: SyncAnchor[] = [
  ...
  { sectionId: 'anatomie', blockIndex: 5, slide: 4 },
  { sectionId: 'anatomie', blockIndex: 27, slide: 5 },
  { sectionId: 'anatomie', blockIndex: 45, slide: 6 },
  { sectionId: 'vascularisation', blockIndex: 0, slide: 7 },
  { sectionId: 'innervation', blockIndex: 1, slide: 8 },
  { sectionId: 'physiologie', blockIndex: 2, slide: 9, gapBefore: 'half' },
  { sectionId: 'physiologie', blockIndex: 14, slide: 10 },
  { sectionId: 'physiologie', blockIndex: 18, slide: 11 },
  { sectionId: 'pathologies-courantes-diagnostic-d-exclusion-indications-troubles-fonctionnels', blockIndex: 0, slide: 12 },
  { sectionId: 'pathologies-courantes-diagnostic-d-exclusion-indications-troubles-fonctionnels', blockIndex: 2, slide: 13 },
  { sectionId: 'pathologies-courantes-diagnostic-d-exclusion-indications-troubles-fonctionnels', blockIndex: 28, slide: 14 },
  { sectionId: 'relations-viscero-somatiques', blockIndex: 1, slide: 15 },
  { sectionId: 'conseils', blockIndex: 1, slide: 16 },
  { sectionId:'zones-reflexes-podales',blockIndex:4,slide:17,end:{sectionId:'zones-reflexes-podales',blockIndex:4} },
  { sectionId:'zones-reflexes-podales',blockIndex:4,slide:18,end:{sectionId:'zones-reflexes-podales',blockIndex:4} },
  { sectionId:'zones-reflexes-podales',blockIndex:26,slide:19,end:{sectionId:'zones-reflexes-podales',blockIndex:26} },
  { sectionId:'zones-reflexes-podales',blockIndex:27,slide:20,end:{sectionId:'zones-reflexes-podales',blockIndex:27} },
  { sectionId:'zones-reflexes-podales',blockIndex:17,slide:21,end:{sectionId:'zones-reflexes-podales',blockIndex:18} },
  { sectionId:'zones-reflexes-podales',blockIndex:39,slide:22,end:{sectionId:'zones-reflexes-podales',blockIndex:39} },
  { sectionId:'zones-reflexes-podales',blockIndex:29,slide:23,end:{sectionId:'zones-reflexes-podales',blockIndex:29} },
  { sectionId:'zones-reflexes-podales',blockIndex:41,slide:24,end:{sectionId:'zones-reflexes-podales',blockIndex:41} },
]
