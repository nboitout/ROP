  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'lead', label: 'Treitz-Muskel', text: 'er trägt durch seine Kontraktion zur Aufrechterhaltung des duodenojejunalen Winkels bei, indem er die Mesenterialwurzel nach oben und links zieht.' },
        { type: 'para', text: 'Durch die Förderung der Längsspannung beteiligt er sich an der Entleerung des Duodenalinhalts in das Jejunum. Die Mesenterialwurzel versorgt den Dünndarm mit Gefäßen und Nerven.' },
        { type: 'figure', src: '/chapter-14/ge/Chapter14 Fig4 GE.png', caption: 'Abbildung 14.4 — Treitz-Muskel', alt: 'Treitz-Muskel und duodenojejunaler Winkel', orientation: 'landscape', syncHide: true },
        { type: 'rop', body: [
