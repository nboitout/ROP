...
export const chapter2Slides: SyncSlide[] = [
  ...
  { src: '/chapter-2/slides/slide-02.png?v=6254c01', title: 'L’exigence du geste thérapeutique' },
...
export const chapter2SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'hierarchisation', blockIndex: 3, slide: 10, ...endAt('hierarchisation', 5) },
  { sectionId: 'hierarchisation', blockIndex: 5, slide: 11, ...endAt('hierarchisation', 7) },
  { sectionId: 'hierarchisation', blockIndex: 7, slide: 12, ...endAt('exemple-clinique', -1) },
