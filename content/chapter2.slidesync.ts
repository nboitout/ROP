...
export const chapter2Slides: SyncSlide[] = [
  ...
  { src: '/chapter-2/slides/slide-03.png', title: 'La pression fine sollicite les mécanorécepteurs superficiels' },
  { src: '/chapter-2/slides/slide-04.png', title: 'La pression en ROP : une action superficielle' },
  { src: '/chapter-2/slides/slide-05.png', title: 'Le système lemniscal et le contrôle de la douleur' },
...
export const chapter2SlideAnchorsFr: SyncAnchor[] = [
  ...
  { sectionId: 'technique', blockIndex: 8, slide: 5, ...endAt('technique', 9) },
  { sectionId: 'technique', blockIndex: 9, slide: 6, ...endAt('modalites', -1) },
  ...
  { sectionId: 'zones-reflexes', blockIndex: 6, slide: 10, ...endAt('zones-reflexes', 8) },
  { sectionId: 'zones-reflexes', blockIndex: 9, slide: 11, ...endAt('exemple-clinique', -1) },
