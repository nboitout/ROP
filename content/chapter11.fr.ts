...
chapter11Reflex.blocks = [
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-01.png', caption: 'Photo : Foie — lobe gauche', alt: 'Repère podal du lobe gauche du foie', orientation: 'landscape' },
  { type: 'bullets', items: [
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-04.png', caption: 'Photo : Vésicule biliaire', alt: 'Repère podal de la vésicule biliaire sur le pouce gauche', orientation: 'portrait' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-05.png', caption: 'Photo : Voies biliaires', alt: 'Repère podal des voies biliaires entre les deux pouces', orientation: 'portrait' },
  { type: 'xref', label: 'Voir le chapitre 7 — Socle régional abdominal et péritonéal', href: '/lecture/chapitre-7?lang=fr' },
  { type: 'xref', label: 'Voir le chapitre 10 — Duodénum', href: '/lecture/chapitre-10?lang=fr' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-07.png', caption: 'Photo : Nerf phrénique C3-C4-C5', alt: 'Repère podal du nerf phrénique C3 C4 C5', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-09.png', caption: 'Photo : Nerf phrénique — triangle de Sédillot', alt: 'Repère podal du nerf phrénique dans le triangle de Sédillot', orientation: 'landscape' },
  { type: 'para', text: 'Balance cerveau limbique-foie/vésicule biliaire. Dans le vocabulaire propre à la ROP, l’écoute-induction associe un pouce sur la zone foie/vésicule biliaire et l’autre sur la zone du cerveau limbique.' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-10.png', caption: 'Photo : Balance cerveau limbique — foie/vésicule biliaire', alt: 'Technique balance cerveau limbique foie-vésicule biliaire', orientation: 'portrait' },
  { type: 'xref', label: 'Voir le chapitre 3 — Système nerveux central', href: '/lecture/chapitre-3?lang=fr' },
