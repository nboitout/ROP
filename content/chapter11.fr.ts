...
const reflexFigure = (
  ...
  type: "figure",
  src: `/chapter-11/FR/cartographies/figure-11-${n}.png`,
  caption: `${kind} : ${title}`,
  alt,
  orientation,
})
...
chapter11Reflex.title = '14. Zones réflexes ROP du foie et des voies biliaires'
chapter11Reflex.blocks = [
  { type: 'note', label: 'Précision méthodologique', body: ['Les localisations décrites ci-dessous appartiennent à la cartographie clinique de la ROP. Pour le foie et les voies biliaires, le protocole associe la zone spécifique foie-vésicule-voies biliaires, la régulation neuro-végétative et adaptative, l’environnement loco-régional abdominal, puis l’intégration viscéro-somatique et la Balance cerveau limbique-foie/vésicule biliaire.'] },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-03.png', caption: 'Photo : Foie — face inférieure et lobe droit', alt: 'Repère podal de la face inférieure et du lobe droit du foie', orientation: 'portrait' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-04.png', caption: 'Photo : Vésicule biliaire', alt: 'Repère podal de la vésicule biliaire', orientation: 'portrait' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-05.png', caption: 'Photo : Voies biliaires', alt: 'Repère podal des voies biliaires', orientation: 'portrait' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-07.png', caption: 'Photo : Nerf phrénique C3-C4-C5', alt: 'Repère podal du nerf phrénique', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-09.png', caption: 'Photo : Nerf phrénique — triangle de Sédillot', alt: 'Repère podal du nerf phrénique au triangle de Sédillot', orientation: 'landscape' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-10.png', caption: 'Photo : Balance cerveau limbique — foie/vésicule biliaire', alt: 'Technique de balance cerveau limbique et foie-vésicule biliaire', orientation: 'portrait' },
...
chapter11Reflex.blocks = [
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-08.png', caption: 'Photo : Foie — lobe gauche', alt: 'Repère podal du lobe gauche du foie', orientation: 'landscape' },
  { type: 'bullets', items: [
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-12.png', caption: 'Photo : Foie — face inférieure et lobe droit', alt: 'Repère podal de la face inférieure et du lobe droit du foie', orientation: 'portrait' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-14.png', caption: 'Photo : Vésicule biliaire', alt: 'Repère podal de la vésicule biliaire sur le pouce gauche', orientation: 'portrait' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-16.png', caption: 'Photo : Voies biliaires', alt: 'Repère podal des voies biliaires entre les deux pouces', orientation: 'portrait' },
  { type: 'xref', label: 'Voir le chapitre 7 — Socle régional abdominal et péritonéal', href: '/lecture/chapitre-7?lang=fr' },
  { type: 'xref', label: 'Voir le chapitre 10 — Duodénum', href: '/lecture/chapitre-10?lang=fr' },
  ...
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-18.png', caption: 'Photo : Nerf phrénique C3-C4-C5', alt: 'Repère podal du nerf phrénique C3 C4 C5', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-20.png', caption: 'Photo : Nerf phrénique — triangle de Sédillot', alt: 'Repère podal du nerf phrénique dans le triangle de Sédillot', orientation: 'landscape' },
  { type: 'para', text: 'Balance cerveau limbique-foie/vésicule biliaire. Dans le vocabulaire propre à la ROP, l’écoute-induction associe un pouce sur la zone foie/vésicule biliaire et l’autre sur la zone du cerveau limbique.' },
  { type: 'figure', src: '/chapter-11/FR/cartographies/figure-11-22.png', caption: 'Photo : Balance cerveau limbique — foie/vésicule biliaire', alt: 'Technique balance cerveau limbique foie-vésicule biliaire', orientation: 'portrait' },
  { type: 'xref', label: 'Voir le chapitre 3 — Système nerveux central', href: '/lecture/chapitre-3?lang=fr' },
