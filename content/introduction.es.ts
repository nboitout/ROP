...
// Source: public/chapter-0/Chapter_0_Introduction_ROP_Spanish.docx
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { type: 'para', text: 'El propósito sigue siendo el mismo: proponer una cartografía coherente, alineada con la anatomía y la fisiología, concebida de forma tridimensional, con el cuerpo representado como un lactante en posición fetal dentro del pie y articulada con las zonas reflejas occipitales.' },
      ],
    },
    {
      id: 'en-bref',
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          'Puntos de referencia clínicos y una lógica de palpación para localizar las zonas reflejas, pese a la escasez de reparos óseos disponibles en la superficie plantar.',
    ...
    },
    {
      ...
      blocks: [
        { type: 'para', text: 'Como ocurre en cualquier enfoque terapéutico manual, en ocasiones observamos resultados que no pueden objetivarse por completo. La observación clínica no posee el rigor metodológico de un protocolo de laboratorio, pero conserva su valor cuando se lleva a cabo de manera sistemática. Por ello, este libro prioriza: (1) la coherencia anatómica; (2) la reproducibilidad de los puntos de referencia; (3) la correlación con la realidad clínica, incluida la anamnesis del paciente, los hallazgos de imagen y las observaciones quirúrgicas.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'bullets', items: [
          ...
          'Zonas reflejas podales — síndrome general; síndrome locorregional.',
