...
export const chapter4SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'presentation', blockIndex: 19, slide: 3 },
  { sectionId: 'presentation', blockIndex: 20, slide: 4 },
  { sectionId: 'presentation', blockIndex: 21, slide: 5 },
  { sectionId: 'presentation', blockIndex: 21, itemIndex: 3, slide: 6 },
  ...
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 10, slide: 13 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 11, slide: 14 },
  ...
  { sectionId: 'sympathique-visceromoteur', blockIndex: 4, slide: 20 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 7, slide: 21, ...endAt('sympathique-visceromoteur', 8) },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 13, slide: 22, ...endAt('sympathique-sensitif', -1) },
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 9, slide: 30 },
