...
export const chapter4SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'presentation', blockIndex: 20, slide: 4 },
  { sectionId: 'presentation', blockIndex: 21, slide: 5 },
  { sectionId: 'presentation', blockIndex: 22, slide: 6 },
  { sectionId: 'presentation', blockIndex: 22, itemIndex: 3, slide: 7 },
  { sectionId: 'organisation', blockIndex: 0, slide: 8, ...endAt('parasympathique-visceromoteur', -1) },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 1, slide: 9, gapBefore: 'half' },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 2, slide: 10 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 3, slide: 11 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 4, slide: 12 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 5, slide: 13, ...endAt('parasympathique-visceromoteur', 6) },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 12, slide: 14 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 13, slide: 15 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 14, slide: 16 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 16, slide: 17, ...endAt('nerf-vague-sensitif', -1) },
  { sectionId: 'nerf-vague-sensitif', blockIndex: 0, slide: 18, gapBefore: 'half', ...endAt('sympathique-visceromoteur', -1) },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 0, slide: 19, gapBefore: 'half' },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 2, slide: 20 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 5, slide: 21 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 9, slide: 22, ...endAt('sympathique-visceromoteur', 10) },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 18, slide: 23, ...endAt('sympathique-sensitif', -1) },
  { sectionId: 'sympathique-sensitif', blockIndex: 0, slide: 24, gapBefore: 'half', ...endAt('chaine-plexique-prevertebrale', -1) },
  { sectionId: 'chaine-plexique-prevertebrale', blockIndex: 0, slide: 25 },
  { sectionId: 'plexus-pelvien', blockIndex: 0, slide: 26 },
  { sectionId: 'sne', blockIndex: 0, slide: 27 },
  { sectionId: 'glandes-surrenales', blockIndex: 2, slide: 28, ...endAt('zones-reflexes-podales', -1) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 0, slide: 29, ...endAt('zones-reflexes-podales', 1, 9) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 2, slide: 30, ...endAt('zones-reflexes-podales', 3) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 5, slide: 31, ...endAt('zones-reflexes-podales', 7) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 7, slide: 32, ...endAt('zones-reflexes-podales', 8) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 10, slide: 33, ...endAt('zones-reflexes-podales', 12) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 34, ...endAt('zones-reflexes-podales', 16) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 18, slide: [35, 36], ...endAt('zones-reflexes-podales', 20) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 22, slide: 37, ...endAt('zones-reflexes-podales', 23) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 23, slide: 38, ...endAt('zones-reflexes-podales', 24) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 39, ...endAt('zones-reflexes-podales', 25) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 40, ...endAt('zones-reflexes-podales', 32) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 34, slide: 41, ...endAt('zones-reflexes-podales', 36) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 50, slide: 42, ...endAt('zones-reflexes-podales', 51) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 51, slide: 43, ...endAt('zones-reflexes-podales', 52) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 52, slide: 44 },
]
