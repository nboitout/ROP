...
export const chapter4Slides: SyncSlide[] = [
  ...
  { src: '/chapter-4/slides/slide-05.png', title: 'Origine cranienne du Parasympathique' },
  ...
  { src: '/chapter-4/slides/slide-08.png', title: 'Le nerf vague X : chef d orchestre vegetatif' },
  { src: '/chapter-4/slides/slide-12.png', title: 'Carrefours strategiques du cou' },
  ...
  { src: '/chapter-4/slides/slide-09.png', title: 'Nerf vague X : role sensitif et interoception' },
  { src: '/chapter-4/slides/slide-17.png', title: 'Sympathique : origines medullaires' },
  { src: '/chapter-4/slides/slide-10.png', title: 'La chaine ganglionnaire latero-vertebrale' },
  ...
  { src: '/chapter-4/slides/slide-19.png', title: 'Chaine sympathique cervicale' },
  { src: '/chapter-4/slides/slide-21.png', title: 'Les nerfs splanchniques : l autoroute abdominale' },
  { src: '/chapter-4/slides/slide-25.png', title: 'Interoception, nociception et douleurs rapportees' },
  { src: '/chapter-4/slides/slide-20.png', title: 'Plexus prevertebraux abdominaux' },
  { src: '/chapter-4/slides/slide-22.png', title: 'Le carrefour pelvien' },
  { src: '/chapter-4/slides/slide-23.png', title: 'Le systeme nerveux enterique : le deuxieme cerveau' },
  { src: '/chapter-4/slides/slide-24.png', title: 'Zones reflexes podales : grands reperes du SNA' },
  { src: '/chapter-4/slides/slide-26.png', title: 'Principes therapeutiques en ROP' },
]
...
export const chapter4SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 1, slide: 5 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 3, slide: 6 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 4, slide: 7 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 6, slide: 8 },
  { sectionId: 'parasympathique-visceromoteur', blockIndex: 7, slide: 9 },
  ...
  { sectionId: 'sympathique-visceromoteur', blockIndex: 1, slide: 16 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 2, slide: 17 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 5, slide: 18 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 9, slide: 19 },
  { sectionId: 'sympathique-visceromoteur', blockIndex: 18, slide: 20 },
  { sectionId: 'sympathique-sensitif', blockIndex: 0, slide: 21, gapBefore: 'half' },
  { sectionId: 'chaine-plexique-prevertebrale', blockIndex: 0, slide: 22 },
  { sectionId: 'plexus-pelvien', blockIndex: 0, slide: 23 },
  { sectionId: 'sne', blockIndex: 0, slide: 24 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 0, slide: 25, gapBefore: 'half' },
  { sectionId: 'zones-reflexes-podales', blockIndex: 40, slide: 26 },
]
