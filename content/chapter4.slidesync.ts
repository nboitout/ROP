...
export const chapter4Slides: SyncSlide[] = [
  { src: '/chapter-4/FR/slides/slide-01.png', title: 'Système nerveux autonome' },
  { src: '/chapter-4/FR/slides/slide-02.png', title: 'Deux systèmes : Parasympathique et Sympathique' },
  { src: '/chapter-4/FR/slides/slide-03.png', title: 'L’équilibre du milieu intérieur' },
  { src: '/chapter-4/FR/slides/slide-04.png', title: 'Physiologie générale du SNA' },
  { src: '/chapter-4/FR/slides/slide-05.png', title: 'Cartographie des innervations' },
  { src: '/chapter-4/FR/slides/slide-06.png', title: 'Relation Parasympathique–Sympathique' },
  { src: '/chapter-4/FR/slides/slide-07.png', title: 'Interdépendance fonctionnelle au sein des plexus autonomes' },
  { src: '/chapter-4/FR/slides/slide-08.png', title: 'Neuro-endocrinologie et neuromédiateurs' },
  { src: '/chapter-4/FR/slides/slide-09.png', title: 'Le sommeil : prérequis de l’équilibre autonome' },
  { src: '/chapter-4/FR/slides/slide-10.png', title: 'Organisation fonctionnelle du système nerveux autonome' },
  { src: '/chapter-4/FR/slides/slide-11.png', title: 'Organisation crânio-sacrale du parasympathique' },
  { src: '/chapter-4/FR/slides/slide-12.png', title: 'Innervation parasympathique céphalique : les ganglions crâniens' },
  { src: '/chapter-4/FR/slides/slide-13.png', title: 'Origines motrices du nerf vague : noyau dorsal et noyau ambigu' },
  { src: '/chapter-4/FR/slides/slide-14.png', title: 'Le trajet du nerf vague (X) : du crâne à l’abdomen' },
  { src: '/chapter-4/FR/slides/slide-15.png', title: 'Les troncs vagaux : passage diaphragmatique et distribution abdominale' },
  { src: '/chapter-4/FR/slides/slide-16.png', title: 'Le Parasympathique pelvien' },
  { src: '/chapter-4/FR/slides/slide-17.png', title: 'Nerf vague viscéro-sensitif : intéroception' },
  { src: '/chapter-4/FR/slides/slide-18.png', title: 'Intéroception, nociception et douleurs rapportées' },
  { src: '/chapter-4/FR/slides/slide-19.png', title: 'Les dermalgies réflexes' },
  { src: '/chapter-4/FR/slides/slide-20.png', title: 'Chaîne plexique prévertébrale (ou pré-aortique)' },
  { src: '/chapter-4/FR/slides/slide-21.png', title: 'Intéroception, nociception et douleurs rapportées — application en ROP' },
  { src: '/chapter-4/FR/slides/slide-22.png', title: 'Plexus prévertébraux : convergence vagale et sympathique' },
  { src: '/chapter-4/FR/slides/slide-23.png', title: 'Le plexus hypogastrique inférieur' },
  { src: '/chapter-4/FR/slides/slide-24.png', title: 'Fonctions pelviennes : contrôle autonome et somatique' },
  { src: '/chapter-4/FR/slides/slide-25.png', title: 'Le système nerveux entérique : autonomie locale et modulation extrinsèque' },
  { src: '/chapter-4/FR/slides/slide-26.png', title: 'Les glandes surrénales et le stress' },
  { src: '/chapter-4/FR/slides/slide-27.png', title: 'Synthèse : trois modalités coordonnées de régulation viscérale' },
  { src: '/chapter-4/FR/slides/slide-28.png', title: 'Zones réflexes podales du SNA' },
...
export const chapter4SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'presentation', blockIndex: 20, slide: 8, ...endAt('presentation', 20, 2) },
  ...
  { sectionId: 'parasympathique-visceromoteur', blockIndex: -1, slide: 11, gapBefore: 'half', ...endAt('parasympathique-visceromoteur', 0) },
  ...
  { sectionId: 'nerf-vague-sensitif', blockIndex: 0, slide: 17, ...endAt('sympathique-visceromoteur', -1) },
  { sectionId: 'sympathique-visceromoteur', blockIndex: -1, slide: 18, ...endAt('sympathique-sensitif', 0, 6) },
  ...
  { sectionId: 'plexus-pelvien', blockIndex: 0, slide: 23, ...endAt('plexus-pelvien', 0, 4) },
  { sectionId: 'plexus-pelvien', blockIndex: 0, itemIndex: 5, slide: 24, ...endAt('plexus-pelvien', 0, 11) },
