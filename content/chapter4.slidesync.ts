...
export const chapter4SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 14, slide: 31, ...endAt('zones-reflexes-podales', 16) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 18, slide: [32, 33], ...endAt('zones-reflexes-podales', 20) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 22, slide: 34, ...endAt('zones-reflexes-podales', 23) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 23, slide: 35, ...endAt('zones-reflexes-podales', 24) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 36, ...endAt('zones-reflexes-podales', 25) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 30, slide: 37, ...endAt('zones-reflexes-podales', 32) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 34, slide: 38, ...endAt('zones-reflexes-podales', 36) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 50, slide: 39, ...endAt('zones-reflexes-podales', 51) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 51, slide: 40, ...endAt('zones-reflexes-podales', 52) },
  { sectionId: 'zones-reflexes-podales', blockIndex: 52, slide: 41 },
]
