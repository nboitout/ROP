    ...
    },
    {
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          'On the right, the ileum does not overlap the ascending colon;',
          'Dorsally, the small intestine is related to the posterior abdominal wall and to the retroperitoneal organs, particularly the supramesocolic part of the duodenum, the kidneys, the ureters and the ascending and descending colons;',
          'Ventrally: the greater omentum;',
