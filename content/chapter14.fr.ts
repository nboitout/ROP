...
chapter14Reflex.blocks = [
  ...
  { type: 'para', text: 'Selon les tests, des soutiens fonctionnels peuvent être associés : foie et système porte, pancréas, duodénum et, dans certains contextes d’adaptation, surrénales. Ils ne constituent pas des étapes obligatoires du traitement de l’intestin grêle.' },
  ...
  { type: 'figure', src: '/chapter-14/cartographie/figure-14-02.png', caption: 'Photo : Racine du mésentère — jonction duodéno-jéjunale à ombilic', alt: 'Repère podal de la racine du mésentère entre la jonction duodéno-jéjunale et l’ombilic', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-14/cartographie/figure-14-04.png', caption: 'Photo : Racine du mésentère — valvule iléo-cæcale à ombilic', alt: 'Repère podal de la racine du mésentère entre la valvule iléo-cæcale et l’ombilic', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-14/cartographie/figure-14-06.png', caption: 'Photo : Jéjunum — limites supérieure et inférieure', alt: 'Repère podal du jéjunum sur le pied gauche', orientation: 'landscape' },
  { type: 'figure', src: '/chapter-14/cartographie/figure-14-08.png', caption: 'Photo : Iléum — limites supérieure et inférieure', alt: 'Repère podal de l’iléum sur le pied droit', orientation: 'landscape' },
  { type: 'xref', label: 'Voir le chapitre 7 — Socle régional abdominal et péritonéal', href: '/lecture/chapitre-7?lang=fr' },
  ...
  { type: 'figure', src: '/chapter-14/cartographie/figure-14-09.png', caption: 'Photo : Balance viscéro-émotionnelle — intestin grêle', alt: 'Technique de balance viscéro-émotionnelle de l’intestin grêle', orientation: 'landscape' },
  { type: 'xref', label: 'Voir le chapitre 3 — Système nerveux central', href: '/lecture/chapitre-3-rework?lang=fr' },
