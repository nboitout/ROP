  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          'À gauche, le jéjunum recouvre le colon descendant.',
          'À droite, l’iléum laisse libre le colon ascendant.',
          'Dorsalement, l’intestin grêle répond à la paroi abdominale postérieure et aux organes rétro-péritonéaux, notamment la partie sus-mésocolique du duodénum, les reins, les uretères et les colons ascendant et descendant.',
          'Ventralement : le grand omentum (anciennement grand épiploon).',
          'Caudalement : les organes pelviens, surtout la vessie.',
          'Céphaliquement : le mésocolon transverse.',
        ]},
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'figure', src: '/chapter-14/Chapter14 Fig19 FR.png', caption: 'Figure 14.19 — Système sympathique (origine médullaire)', alt: 'Système sympathique et chaîne ganglionnaire', orientation: 'landscape' },
