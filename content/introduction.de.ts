// Introduction - German
// Source: public/chapter-0/Chapter0 Introduction DE.docx
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { type: 'para', text: "Der Anspruch bleibt derselbe: eine kohärente Kartographie bereitzustellen, die mit Anatomie und Physiologie übereinstimmt, dreidimensional gedacht ist, den Körper als Säugling in Fötalstellung im Fuß abbildet und mit den okzipitalen Reflexzonen in Beziehung setzt. Zusammen bilden die okzipitalen und plantaren Reflexzonen die ROP-Reflexzonen." },
      ],
    },
    {
      id: "en-bref",
      ...
      blocks: [
        { type: 'bullets', items: [
          ...
          "Klinische Orientierungspunkte und eine palpationsbasierte Rationale zur Lokalisierung der ROP-Reflexzonen an den Fußsohlen, trotz der wenigen knöchernen Landmarken an der Plantarfläche.",
    ...
    },
    {
      ...
      blocks: [
        { type: 'para', text: "Wie bei jedem manualtherapeutischen Ansatz beobachten wir mitunter Ergebnisse, die sich nicht vollständig objektivieren lassen. Die klinische Beobachtung besitzt nicht die methodische Strenge eines Laborprotokolls, behält jedoch ihren Wert, wenn sie systematisch durchgeführt wird. Deshalb legt dieses Buch den Schwerpunkt auf:" },
        { type: 'bullets', items: [
          "anatomische Kohärenz;",
          "Reproduzierbarkeit der Orientierungspunkte;",
          "Korrelation mit der klinischen Realität, einschließlich Anamnese, bildgebender Befunde und chirurgischer Beobachtungen.",
        ]},
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'bullets', items: [
          ...
          "ROP-Reflexzonen – plantare Kartographie (allgemeines Syndrom; lokoregionales Syndrom).",
