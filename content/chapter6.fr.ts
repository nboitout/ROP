  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'rop', body: [
          'De ce qui découle du fonctionnement hiérarchisé du SNA en trois branches correspondant à l’évolution phylogénétique des trois cerveaux — reptilien, limbique et cognitif de Paul D. Maclean —, il faut organiser notre approche thérapeutique, non seulement par l’anamnèse et l’examen clinique, mais aussi selon cette hiérarchisation de haut en bas des trois cerveaux.',
