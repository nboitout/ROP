...
export const chapter10SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 16, slide: 15, end: { sectionId: 'zones-reflexes-podales', blockIndex: 17 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 17, slide: 16, end: { sectionId: 'zones-reflexes-podales', blockIndex: 18 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 34, slide: 17, end: { sectionId: 'zones-reflexes-podales', blockIndex: 36 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 23, slide: 18 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 25, slide: 19 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 26, slide: 20, gapBefore: 'half' },
  { sectionId: 'zones-reflexes-podales', blockIndex: 27, slide: 21 },
]
