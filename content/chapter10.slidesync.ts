...
export const chapter10SlideAnchors: SyncAnchor[] = [
  ...
  { sectionId: 'zones-reflexes-podales', blockIndex: 15, slide: 15, end: { sectionId: 'zones-reflexes-podales', blockIndex: 16 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 16, slide: 16, end: { sectionId: 'zones-reflexes-podales', blockIndex: 17 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 33, slide: 17, end: { sectionId: 'zones-reflexes-podales', blockIndex: 35 } },
  { sectionId: 'zones-reflexes-podales', blockIndex: 22, slide: 18 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 24, slide: 19 },
  { sectionId: 'zones-reflexes-podales', blockIndex: 25, slide: 20, gapBefore: 'half' },
  { sectionId: 'zones-reflexes-podales', blockIndex: 26, slide: 21 },
]
