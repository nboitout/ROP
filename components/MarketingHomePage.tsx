    ...
    <main>
      ...
      <header>
        ...
        <div className="h-right">
          <nav>
            <Link href={localizedHref('/equipe', lang)}>{t.nav.equipe}</Link>
      ...
      <section id="protocole">
        ...
        <div className="protocol-intro">
          ...
          {' '}
          <Link href={localizedHref('/lecture/traitement-rop', lang)} onClick={() => trackCta('protocol_free_chapter')}>{t.protocole.freeCta}</Link>
        </div>
      ...
      <section id="acheter">
        ...
        <div className="pricing-readfirst">
          ...
          <Link href={localizedHref('/chapitres-gratuits', lang)} className="btn b-gold" style={{ display: 'inline-block' }} onClick={() => trackCta('pricing_readfirst')}>{t.pricing.readFirst.cta}</Link>
        </div>
      ...
      <footer>
        <div>
          ...
          <p>{t.footer.p}</p>
          <Link href={localizedHref('/equipe', lang)} className="f-team-link">{t.nav.equipe} →</Link>
        </div>
        <div className="f-bot">
