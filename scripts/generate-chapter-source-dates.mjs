...
const sourceDocuments = {
  ...
  'chapter-7': { fr: 'chapter-7/Chapitre_7_[NEW]_ Cavites_abdominale_et_peritoneale_socle_regional_revise.docx', en: 'chapter-7/EN/Chapter_7_Abdominal_and_Peritoneal_Cavities_ROP_English_Revised.docx' },
