...
export const chapterMetaSnapshot: Record<string, ChapterMetaSnapshot> = {
  ...
  'chapter-8': { readingMinutes: 29, photoCount: 6, slideCount: 16, cartographyCount: 11, visualCount: 33 },
  'chapter-9': { readingMinutes: 22, photoCount: 2, slideCount: 19, cartographyCount: 4, visualCount: 25 },
  'chapter-10': { readingMinutes: 16, photoCount: 4, slideCount: 13, cartographyCount: 5, visualCount: 22 },
  'chapter-11': { readingMinutes: 37, photoCount: 6, slideCount: 14, cartographyCount: 4, visualCount: 24 },
  ...
  'chapter-15': { readingMinutes: 37, photoCount: 3, slideCount: 28, cartographyCount: 3, visualCount: 34 },
  'chapter-16': { readingMinutes: 36, photoCount: 5, slideCount: 22, cartographyCount: 6, visualCount: 33 },
  'chapter-17': { readingMinutes: 29, photoCount: 6, slideCount: 18, cartographyCount: 7, visualCount: 31 },
  'chapter-18': { readingMinutes: 23, photoCount: 7, slideCount: 21, cartographyCount: 9, visualCount: 37 },
  'chapter-19': { readingMinutes: 35, photoCount: 11, slideCount: 34, cartographyCount: 13, visualCount: 58 },
  'chapter-20': { readingMinutes: 32, photoCount: 10, slideCount: 14, cartographyCount: 11, visualCount: 35 },
  'chapter-21': { readingMinutes: 14, photoCount: 5, slideCount: 10, cartographyCount: 7, visualCount: 22 },
}
