...
export const chapterMetaSnapshot: Record<string, ChapterMetaSnapshot> = {
  ...
  'chapter-9': { readingMinutes: 22, photoCount: 4, slideCount: 18, cartographyCount: 5, visualCount: 27 },
  'chapter-10': { readingMinutes: 16, photoCount: 3, slideCount: 13, cartographyCount: 2, visualCount: 18 },
