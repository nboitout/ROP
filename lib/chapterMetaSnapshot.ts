...
export const chapterMetaSnapshot: Record<string, ChapterMetaSnapshot> = {
  ...
  'chapter-11': { readingMinutes: 37, photoCount: 6, slideCount: 14, cartographyCount: 5, visualCount: 25 },
  ...
  'chapter-16': { readingMinutes: 36, photoCount: 5, slideCount: 21, cartographyCount: 6, visualCount: 32 },
  'chapter-17': { readingMinutes: 29, photoCount: 6, slideCount: 18, cartographyCount: 7, visualCount: 31 },
  'chapter-18': { readingMinutes: 23, photoCount: 7, slideCount: 20, cartographyCount: 9, visualCount: 36 },
  'chapter-19': { readingMinutes: 35, photoCount: 0, slideCount: 33, cartographyCount: 2, visualCount: 35 },
  'chapter-20': { readingMinutes: 25, photoCount: 10, slideCount: 14, cartographyCount: 11, visualCount: 35 },
